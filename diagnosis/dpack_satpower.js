...
module.exports = { PACK: {
  ...
  "rounds": [
    {
      ...
      "alarm": "resist",
      "poleA": {
        "lab": "Source impedance",
        "val": "Resistance estimate 118 mΩ; ordinary −8.4 A discharge",
        "note": "The same current now produces more internal loss and slower recovery."
      },
      ...
      "riddle": "The battery current is not unusually high. <span class=\"q\">Why is the same current now producing a larger voltage loss?</span>",
      "vals": {
        "busv": {
    ...
    },
    {
      ...
      "poleA": {
        "lab": "Demand state",
        "val": "1.18 kW measured; 640 W commanded",
        "note": "A real branch has energized beyond the planned spacecraft load."
      },
      "hook": "A payload mode transition coincides with a sudden bus sag and heavy battery discharge.",
      "riddle": "The extra electrical demand is physically present. <span class=\"q\">What energized it, and does the command history authorize that state?</span>",
      "vals": {
        "busv": {
        ...
        "switch": {
          "observed": "Heater bank H3 closed",
          "reference": "May be planned or uncommanded"
        },
        "eventflag": {
      ...
      "resolve": {
        ...
        "paras": [
          ...
          "Array current alone cannot distinguish an uncommanded load from a planned calibration. Missing authorization alone cannot distinguish excess load from lost generation. Those two quiet readings together force the load-surge diagnosis."
        ],
        "why": {
          "loud": "<b>Why the loud readings tie:</b> both lost generation and excess demand make the battery discharge heavily.",
          "quiet": "<b>Why the tie breaks:</b> the array and Sun geometry remain healthy, while the load telemetry identifies the deficit."
        },
        "chain": [
        ...
        "take": "When storage fills a deficit, compare generation and demand before blaming the battery."
      },
      "logic": [
        [
          "Voltage down + discharge high",
          "Uncommanded load, planned calibration, or lost array input remain"
        ],
        [
          "Array current normal",
          "Uncommanded or planned load remain"
        ],
        [
          "No authorization command",
          "Uncommanded load or lost generation remain"
        ],
        [
          "Normal array + no authorization",
    ...
    },
    {
      ...
      "riddle": "One cause explains the demand and another explains the exaggerated sag. <span class=\"q\">Which two faults are present?</span>",
      "vals": {
        "busv": {
          "observed": "28.0 → 24.9 V / 18 s",
          "reference": "Normal regulated band 27.2–28.4 V"
        },
        "battcur": {
      ...
      "resolve": {
        ...
        "paras": [
          ...
          "The compound round requires four independent measurements. Resistance and pulse recovery jointly prove battery degradation; branch load and physical switch state jointly prove uncommanded equipment activation. Each individual clue has a specific telemetry or operational mimic."
        ],
        "why": {
        ...
        "take": "A severe outcome may reflect an ordinary fault acting on already weakened redundancy or storage."
      },
      "logic": [
        [
  ...
  "schematic": {
    "viewBox": "0 0 520 390",
    "svg": "<defs><linearGradient id=\"cleanBg\" x1=\"0\" y1=\"0\" x2=\"0\" y2=\"1\"><stop offset=\"0\" stop-color=\"#112638\"/><stop offset=\"1\" stop-color=\"#07131c\"/></linearGradient><marker id=\"cleanArrow\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto\"><path d=\"M0 0 L10 5 L0 10 z\" fill=\"#69c9ef\"/></marker><style>.clean-border{fill:url(#cleanBg);stroke:#426273;stroke-width:2}.component{fill:#1b3a4d;stroke:#90b3c4;stroke-width:1.7}.component2{fill:#244c61;stroke:#90b3c4;stroke-width:1.7}.flow{fill:none;stroke:#69c9ef;stroke-width:3;marker-end:url(#cleanArrow)}.flow2{fill:none;stroke:#e0b85f;stroke-width:3;marker-end:url(#cleanArrow)}.leader{fill:none;stroke:#7f9bab;stroke-width:1.25;stroke-linecap:round;stroke-linejoin:round;opacity:.78}.anchor{fill:#9ab8c8}.slabel{fill:#eaf6fb;font:700 10.5px Inter,system-ui,sans-serif}.labelbg{fill:#081923;stroke:#355769;stroke-width:1;opacity:.94}</style></defs><rect x=\"12\" y=\"12\" width=\"496\" height=\"366\" rx=\"24\" class=\"clean-border\"/><path d=\"M 30 70 L 58 70 L 58 75 L 60 75\" class=\"leader\"/><circle cx=\"60\" cy=\"75\" r=\"2.4\" class=\"anchor\"/><path d=\"M 30 130 L 58 130 L 58 160 L 112 160\" class=\"leader\"/><circle cx=\"112\" cy=\"160\" r=\"2.4\" class=\"anchor\"/><path d=\"M 240 35 L 240 68 L 260 68 L 260 180\" class=\"leader\"/><circle cx=\"260\" cy=\"180\" r=\"2.4\" class=\"anchor\"/><path d=\"M 330 35 L 330 68 L 305 68 L 305 244\" class=\"leader\"/><circle cx=\"305\" cy=\"244\" r=\"2.4\" class=\"anchor\"/><path d=\"M 490 110 L 462 110 L 462 160 L 405 160\" class=\"leader\"/><circle cx=\"405\" cy=\"160\" r=\"2.4\" class=\"anchor\"/><path d=\"M 490 165 L 462 165 L 462 215 L 420 215\" class=\"leader\"/><circle cx=\"420\" cy=\"215\" r=\"2.4\" class=\"anchor\"/><path d=\"M 490 220 L 462 220 L 462 265 L 430 265\" class=\"leader\"/><circle cx=\"430\" cy=\"265\" r=\"2.4\" class=\"anchor\"/><path d=\"M 490 275 L 462 275 L 462 305 L 430 305\" class=\"leader\"/><circle cx=\"430\" cy=\"305\" r=\"2.4\" class=\"anchor\"/><path d=\"M 250 355 L 250 327 L 260 327 L 260 285\" class=\"leader\"/><circle cx=\"260\" cy=\"285\" r=\"2.4\" class=\"anchor\"/><path d=\"M 190 355 L 190 327 L 220 327 L 220 305\" class=\"leader\"/><circle cx=\"220\" cy=\"305\" r=\"2.4\" class=\"anchor\"/><path d=\"M 310 355 L 310 327 L 300 327 L 300 305\" class=\"leader\"/><circle cx=\"300\" cy=\"305\" r=\"2.4\" class=\"anchor\"/><path d=\"M 30 305 L 58 305 L 58 305 L 178 305\" class=\"leader\"/><circle cx=\"178\" cy=\"305\" r=\"2.4\" class=\"anchor\"/><circle cx=\"60\" cy=\"75\" r=\"18\" fill=\"#dfb75c\" stroke=\"#ffe2a0\"/><g stroke=\"#dfb75c\" stroke-width=\"2\"><path d=\"M60 45 V35 M60 105 V115 M30 75 H20 M90 75 H100\"/></g><rect x=\"78\" y=\"125\" width=\"72\" height=\"92\" rx=\"10\" class=\"component2\"/><g stroke=\"#a2c1d0\"><path d=\"M96 125 V217 M114 125 V217 M132 125 V217 M78 148 H150 M78 171 H150 M78 194 H150\"/></g><path d=\"M150 170 H192\" class=\"flow\"/><rect x=\"192\" y=\"137\" width=\"136\" height=\"86\" rx=\"14\" class=\"component2\"/><path d=\"M208 180 H312\" stroke=\"#dfb75c\" stroke-width=\"5\"/><path d=\"M260 223 V254\" class=\"flow\"/><rect x=\"204\" y=\"254\" width=\"112\" height=\"70\" rx=\"12\" class=\"component\"/><rect x=\"350\" y=\"128\" width=\"104\" height=\"72\" rx=\"12\" class=\"component\"/><path d=\"M328 180 H350\" class=\"flow\"/><rect x=\"360\" y=\"212\" width=\"92\" height=\"112\" rx=\"12\" class=\"component2\"/><g><rect x=\"75.0\" y=\"223.5\" width=\"76\" height=\"23\" rx=\"11.5\" class=\"labelbg\"/><text x=\"113\" y=\"238.7\" text-anchor=\"middle\" class=\"slabel\">solar array</text></g><g><rect x=\"228.0\" y=\"105.5\" width=\"64\" height=\"23\" rx=\"11.5\" class=\"labelbg\"/><text x=\"260\" y=\"120.7\" text-anchor=\"middle\" class=\"slabel\">main bus</text></g><g><rect x=\"224.0\" y=\"276.5\" width=\"72\" height=\"23\" rx=\"11.5\" class=\"labelbg\"/><text x=\"260\" y=\"291.7\" text-anchor=\"middle\" class=\"slabel\">battery</text></g><g><rect x=\"356.0\" y=\"100.5\" width=\"92\" height=\"23\" rx=\"11.5\" class=\"labelbg\"/><text x=\"402\" y=\"115.7\" text-anchor=\"middle\" class=\"slabel\">spacecraft loads</text></g><g><rect x=\"350.0\" y=\"325.5\" width=\"112\" height=\"23\" rx=\"11.5\" class=\"labelbg\"/><text x=\"406\" y=\"340.7\" text-anchor=\"middle\" class=\"slabel\">command + telemetry</text></g>"
  }
} };
