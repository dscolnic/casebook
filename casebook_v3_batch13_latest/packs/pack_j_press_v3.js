      ...
      "q": [
        ...
        },
        {
          ...
          "clue": {
            "category": "where",
            "label": "WHERE — lead",
            "text": "The newsroom contains the published narrative, but the original incoming headers and attachments survive in the verification archive."
          }
        }
      ]
    },
    "fromrecord": {
      ...
      "q": [
        ...
        },
        {
          ...
          "o": [
            {
              "t": "The witness biography listing an employer that public records fail to verify.",
              "v": "danger",
      ...
      "q": [
        ...
        },
        {
          ...
          "clue": {
            ...
            "text": "Every false persona, incoming document, verification warning, and provenance marker converges in the archived source packet."
          }
        },
        {
