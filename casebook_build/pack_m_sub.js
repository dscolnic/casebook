module.exports = { PACK: {
  ...
  "teaser": "The Sirena vanished during descent, leaving one sharp acoustic pulse and a fragment field well short of the wreck. The inquiry must distinguish collision, an internal life-support casualty, and collapse of a pressure hull weakened over repeated dives.",
  ...
  "overclaimTease": "The famous wreck attracts attention, but event location, fragment deformation, acoustic timing, dive cycles, and material interfaces must agree.",
  "CATS": {
    "who": {
  ...
  "TOPICS": {
    // cell: Salvage Lead Reyes @ The Expedition Dock
    "sd_timoshenko": {
    ...
    // cell: The Acoustics Analyst @ The Expedition Dock
    "sd_langevin": {
    ...
    // cell: The Records Clerk @ The Expedition Dock
    "sd_wohler": {
    ...
    // cell: Salvage Lead Reyes @ The Support Ship
    "sd_piccarda": {
    ...
    // cell: The Acoustics Analyst @ The Support Ship
    "sd_ewing": {
    ...
    // cell: The Records Clerk @ The Support Ship
    "sd_kaiser": {
    ...
    // cell: Salvage Lead Reyes @ The Materials Lab
    "sd_haldane": {
    ...
    // cell: The Acoustics Analyst @ The Materials Lab
    "sd_rayleigh": {
    ...
    // cell: The Records Clerk @ The Materials Lab
    "sd_kwolek": {
  ...
  "story": [
    "<b>The Sirena vanished during descent with one short acoustic pulse and no distress call.</b> Recovery teams found pressure-hull fragments spread above the wreck site, while life-support telemetry remained normal until transmission ended.",
    "A collision should leave a localized breach and place the source at the wreck. A cabin casualty should precede the loss of control. Instead, the recovered shell folded inward and shows progressive damage along material interfaces after many pressure cycles.",
    "The hull engineer assessed allowable life, the operations director managed launch support, and founder-pilot Marcus Vane set the dive schedule and certification policy. The evidence connects hangar inspections, shipboard acoustic logs, and laboratory examination of the fragments.",
    "<b>You have 5 days before the board votes.</b> Identify whose authority kept Sirena diving and where the decisive evidence was accepted or ignored, then weigh collision against a battery or oxygen casualty. Depth, timing, and fracture geometry must explain the final pulse."
  ],
  "endings": {
    "overclaimWhat": "sd_strike",
    "dismissalWhat": "sd_life",
    "win": {
      "expertTitle": "The Case Spine Holds",
      "expert": [
        "At The materials lab and recovered fragments, Marcus Vane — the expedition's founder-pilot continued the dive program after acoustic emissions and delamination findings exceeded the internal limits he had chosen not to submit for independent certification. The decisive record and physical evidence support this conclusion: Fatigue from repeated dives collapsed the hull.",
        "Source location, normal life-support telemetry, inward fragment geometry, interface damage, and accumulated cycles converge on pressure-hull collapse. Independent certification, retirement after the warning threshold, or destructive testing of witness panels would have ended the dive program before failure."
      ],
      "soundTitle": "A Connected, Defensible Finding",
      "sound": [
        "The evidence ties Marcus Vane — the expedition's founder-pilot to The Materials Lab through a specific decision or omission, while the readings independently support Fatigue from repeated dives collapsed the hull",
        "Some timing or custody details remain incomplete, but the mechanism, authority, and decisive location reinforce rather than contradict one another."
      ],
      "namedTitle": "Right Mechanism, Incomplete Accountability",
      "named": [
        "The scientific or historical mechanism may be right, but the accusation has not followed the decisive record at The Materials Lab.",
        "Reconnect that authorization, custody, or concealment to Marcus Vane — the expedition's founder-pilot; a correct WHAT does not excuse a misplaced WHO or WHERE."
      ]
    },
    "overclaim": {
      "title": "The Seductive First Mechanism",
      "body": [
        "It struck the wreck and the pressure hull was breached is tempting because it resembles part of the visible event. Source location, normal life-support telemetry, inward fragment geometry, interface damage, and accumulated cycles converge on pressure-hull collapse.",
        "That choice also breaks the accountability chain by overlooking the record at The Materials Lab that connects the decisive action to Marcus Vane — the expedition's founder-pilot."
      ]
    },
    "dismissal": {
      "title": "The Competing but Incomplete Mechanism",
      "body": [
        "A battery fire or oxygen casualty disabled the crew remains plausible only if the signature it requires appears in the full chronology. Source location, normal life-support telemetry, inward fragment geometry, interface damage, and accumulated cycles converge on pressure-hull collapse.",
        "Accepting it as sufficient would bypass the decisive record at The Materials Lab. Independent certification, retirement after the warning threshold, or destructive testing of witness panels would have ended the dive program before failure."
      ]
    },
    "wrongNames": {
      "title": "The Mechanism Without Accountability",
      "body": [
        "The mechanism may be right, but the accountability chain is not. The decisive record at The Materials Lab ties the action to Marcus Vane — the expedition's founder-pilot; another suspect or location cannot explain that authorization, custody, or concealment."
      ]
    }
  }
}};
