module.exports = { PACK: {
  ...
  "TOPICS": {
    "wd_betz": {
      ...
      "frame": "Blade Tech Aro steadies a blade photograph at The Nacelle & Rotor. \"Use Albert Betz to connect wind loading with the cycles this rotor carried.\"",
      "q": [
        {
    ...
    "wd_lacour": {
      "sci": "Poul la Cour (1846-1908)",
      "topic": "The electricity-generating windmill",
      "lede": "Through the electricity-generating windmill, Poul la Cour connected useful rotor motion with structural endurance.",
      "no": 2,
      "profile": "This rotating-machinery cover note tracks Poul la Cour through the electricity-generating windmill. Poul la Cour built experimental wind turbines in Denmark and used wind-generated electricity for lighting and electrolysis. He studied blade shape and airflow, helping turn the traditional windmill into an engineered power machine. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nUseful wind generation requires matching rotor aerodynamics, generator behavior, storage or grid demand, and mechanical durability. Fatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nControl systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. A wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nAn asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems. Cover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking. The design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits.",
      "frame": "Blade Tech Aro freezes a vibration trace at The Nacelle & Rotor. \"Explain the electricity-generating windmill without pretending one gust tells the whole fatigue history.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Poul la Cour's work on the electricity-generating windmill?",
          "o": [
            {
              "t": "Poul la Cour built experimental wind turbines in Denmark and used wind-generated electricity for lighting and electrolysis. Fatigue evidence ties the raw cycle spectrum to remaining life.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Poul la Cour's wind work emphasizes average load and current power output. Power output appears reassuring. The latest inspection looks acceptable. Wind practice makes the wind view plausible.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Poul la Cour's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. The latest inspection looks acceptable.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Poul la Cour's authority is invoked in wind practice to justify muting vibration alarms when shutdown would sacrifice a productive wind period. The latest inspection looks acceptable.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Useful wind generation requires matching rotor aerodynamics, generator behavior, storage or grid demand, and mechanical durability. The wind-farm archive stores the blade-root finding. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
    ...
    "wd_brush": {
      ...
      "frame": "The SCADA Operator sets a cracked fastener on the table at The Nacelle & Rotor. \"Start with Charles F. Brush; end with what should have been measured.\"",
      "q": [
        {
    ...
    "wd_juul": {
      "sci": "Johannes Juul (1887-1969)",
      "topic": "AC wind power & the Gedser turbine",
      "lede": "Johannes Juul tied aC wind power & the Gedser turbine to the repeated loads carried by real wind machines.",
      "no": 4,
      "profile": "This rotating-machinery cover note tracks Johannes Juul through aC wind power & the Gedser turbine. Johannes Juul designed the Gedser turbine, a three-bladed upwind machine connected to the Danish grid in the 1950s. Its robust layout and aerodynamic tip brakes influenced the architecture of modern wind turbines. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nA successful turbine balances efficiency with passive and active means to limit speed and load during faults or high wind. A wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nFatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. Control systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nThe design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits. An asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems. Cover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking.",
      "frame": "The SCADA Operator steadies a blade photograph at The Nacelle & Rotor. \"Use Johannes Juul to connect wind loading with the cycles this rotor carried.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Johannes Juul's work on aC wind power & the Gedser turbine?",
          "o": [
            {
              "t": "Johannes Juul designed the Gedser turbine, a three-bladed upwind machine connected to the Danish grid in the 1950s. Fatigue evidence ties the turbine-specific rotor vibration trend to remaining life. Fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Johannes Juul's wind work relies on average load and current power output. The rotor still meets demand. A single gust fits the event. Wind records fit this wind account. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Johannes Juul's wind work is read within wind practice as support for normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. Wind records fit this wind account.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Johannes Juul's wind authority supports muting vibration alarms when shutdown would sacrifice a productive wind period. The latest inspection looks acceptable. Wind practice makes the wind view plausible.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A successful turbine balances efficiency with passive and active means to limit speed and load during faults or high wind. The turbine dossier carries the blade-root finding. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
    ...
    "wd_hutter": {
      ...
      "frame": "The Clerk freezes a vibration trace at The Nacelle & Rotor. \"Explain modern wind-turbine blade design without pretending one gust tells the whole fatigue history.\"",
      "q": [
        {
    ...
    "wd_darrieus": {
      "sci": "Georges Darrieus (1888-1979)",
      "topic": "The vertical-axis wind turbine",
      "lede": "Georges Darrieus's work on the vertical-axis wind turbine made wind, vibration, or fatigue an engineering quantity.",
      "no": 6,
      "profile": "This rotating-machinery cover note tracks Georges Darrieus through the vertical-axis wind turbine. Georges Darrieus patented a vertical-axis wind turbine with curved lifting blades. The rotor can accept wind from any horizontal direction, but its cyclic aerodynamic loading and starting behavior differ markedly from horizontal-axis machines. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nA design advantage in orientation can create a different fatigue problem, so load cycles must be evaluated in the actual geometry. Control systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nA wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. Fatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nCover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking. The design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits. An asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems.",
      "frame": "The Clerk sets a cracked fastener on the table at The Nacelle & Rotor. \"Start with Georges Darrieus; end with what should have been measured.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Georges Darrieus's work on the vertical-axis wind turbine?",
          "o": [
            {
              "t": "Georges Darrieus patented a vertical-axis wind turbine with curved lifting blades. The wind-farm archive stores the cycle spectrum. The wind-farm archive stores the dated cycle spectrum.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Georges Darrieus's wind work emphasizes average load and current power output. The latest inspection looks acceptable. Wind context supports the view. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Georges Darrieus's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. Wind practice makes the wind view plausible.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Georges Darrieus's wind authority supports muting vibration alarms when shutdown would sacrifice a productive wind period. A single gust fits the event. Wind records fit this wind account.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A design advantage in orientation can create a different fatigue problem, so load cycles must be evaluated in the actual geometry. The turbine dossier carries the cycle spectrum. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Use one gust or average load while treating the variable-amplitude cycle history as a later engineering refinement. Wind records fit this wind account. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Assume lift, resonance, and fatigue resistance remain stable across yaw, turbulence, surface damage, and operating speed. Wind records fit this wind account. Wind timing supports this wind claim.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
    ...
    "wd_savonius": {
      ...
      "frame": "Blade Tech Aro steadies a blade photograph at The SCADA Control Hut. \"Use Sigurd Savonius to connect wind loading with the cycles this rotor carried.\"",
      "q": [
        {
    ...
    "wd_glauert": {
      ...
      "lede": "Through blade-element momentum & rotor aerodynamics, Hermann Glauert connected useful rotor motion with structural endurance.",
      "no": 8,
      "profile": "This rotating-machinery cover note tracks Hermann Glauert through blade-element momentum & rotor aerodynamics. Hermann Glauert developed aerodynamic theory for propellers and wind turbines, including blade-element momentum methods that combine local airfoil forces with the momentum change of the whole streamtube. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nRotor loads must be integrated along the blade; a local lift calculation alone cannot predict thrust, torque, or fatigue. Fatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nControl systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. A wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nAn asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems. Cover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking. The design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits.",
      "frame": "Blade Tech Aro freezes a vibration trace at The SCADA Control Hut. \"Explain blade-element momentum & rotor aerodynamics without pretending one gust tells the whole fatigue history.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Hermann Glauert's work on blade-element momentum & rotor aerodynamics?",
          "o": [
            {
              "t": "Hermann Glauert developed aerodynamic theory for propellers and wind turbines, including blade-element momentum methods that combine local airfoil forces with the momentum change of. The turbine dossier carries the blade-root finding.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Hermann Glauert's wind work relies on average load and current power output. The rotor still meets demand. A single gust fits the event. Wind records fit this wind account. Wind context supports the view. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Hermann Glauert's wind work is read within wind practice as support for normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. A single gust fits the event. Wind records fit this wind account.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Hermann Glauert's wind authority supports muting vibration alarms when shutdown would sacrifice a productive wind period. Power output appears reassuring. The latest inspection looks acceptable. Wind practice makes the wind view plausible.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Rotor loads must be integrated along the blade; a local lift calculation alone cannot predict thrust, torque, or fatigue. The wind-farm archive stores the dated turbine service record. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
    ...
    "wd_kutta": {
      ...
      "frame": "The SCADA Operator sets a cracked fastener on the table at The SCADA Control Hut. \"Start with Martin Kutta; end with what should have been measured.\"",
      "q": [
        {
    ...
    "wd_rayleigh": {
      ...
      "topic": "Vibration & resonance",
      "lede": "Lord Rayleigh tied vibration & resonance to the repeated loads carried by real wind machines.",
      "no": 10,
      "profile": "This rotating-machinery cover note tracks Lord Rayleigh through vibration & resonance. Lord Rayleigh developed foundational methods for vibration, acoustics, and resonance. The Rayleigh quotient provides an efficient estimate of a structure's natural frequency from its mass and stiffness distribution. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nWhen periodic forcing approaches a natural frequency, modest inputs can create large motion and accelerate fatigue. A wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nFatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. Control systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nRayleigh's vibration analysis explains the resonance alternative. Resonance requires repeated excitation near a natural frequency, producing a strong narrow-band response and a deformation pattern tied to a structural mode. SCADA spectra, tower strain, and nacelle acceleration should therefore show persistent frequency locking before failure. Broad vibration caused by a loosening joint may grow without that modal signature; a bent tower after impact is not by itself evidence that resonance initiated the collapse.",
      "frame": "The SCADA Operator steadies a blade photograph at The SCADA Control Hut. \"Use Lord Rayleigh to connect wind loading with the cycles this rotor carried.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Lord Rayleigh's work on vibration & resonance?",
          "o": [
            {
              "t": "Lord Rayleigh developed foundational methods for vibration, acoustics, and resonance. Fatigue evidence ties the raw cycle spectrum to remaining life. Structural review keeps the raw cycle spectrum available for assessment.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Lord Rayleigh's treatment of vibration & resonance uses a wind simplification: average load and current power output, with variable cycle history and crack growth treated as later detail. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Lord Rayleigh's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. The latest inspection looks acceptable. Wind practice makes the wind view plausible.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Lord Rayleigh's authority is invoked in wind practice to justify muting vibration alarms when shutdown would sacrifice a productive wind period. The latest inspection looks acceptable. Wind practice makes the wind view plausible.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "When periodic forcing approaches a natural frequency, modest inputs can create large motion and accelerate fatigue. The wind-farm archive stores the raw blade-root finding. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
    ...
    "wd_stodola": {
      ...
      "frame": "The Clerk freezes a vibration trace at The SCADA Control Hut. \"Explain turbine blades & vibration without pretending one gust tells the whole fatigue history.\"",
      "q": [
        {
    ...
    "wd_mohr": {
      "sci": "Otto Mohr (1835-1918)",
      "topic": "Stress analysis & Mohr's circle",
      "lede": "Otto Mohr's work on stress analysis & Mohr's circle made wind, vibration, or fatigue an engineering quantity.",
      "no": 12,
      "profile": "This rotating-machinery cover note tracks Otto Mohr through stress analysis & Mohr's circle. Otto Mohr developed graphical methods for transforming stress components, now represented by Mohr's circle. The construction reveals principal stresses and maximum shear on differently oriented planes. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nA bolt or blade may fail on a plane not aligned with the applied load, so multiaxial stress must be resolved before fatigue is judged. Control systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nA wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. Fatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nCover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking. The design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits. An asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems.",
      "frame": "The Clerk sets a cracked fastener on the table at The SCADA Control Hut. \"Start with Otto Mohr; end with what should have been measured.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Otto Mohr's work on stress analysis & Mohr's circle?",
          "o": [
            {
              "t": "Otto Mohr developed graphical methods for transforming stress components, now represented by Mohr's circle. Fatigue evidence ties the dated rotor vibration trend to remaining life.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Otto Mohr's wind work emphasizes average load and current power output. Power output appears reassuring. The latest inspection looks acceptable. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Otto Mohr's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. The latest inspection looks acceptable.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Otto Mohr's wind authority supports muting vibration alarms when shutdown would sacrifice a productive wind period. Wind records fit this wind account. Wind timing supports this wind claim.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A bolt or blade may fail on a plane not aligned with the applied load, so multiaxial stress must be resolved before fatigue is judged. The turbine dossier carries the cycle spectrum. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Use one gust or average load while treating the variable-amplitude cycle history as a later engineering refinement. Power output appears reassuring. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Assume lift, resonance, and fatigue resistance remain stable across yaw, turbulence, surface damage, and operating speed. Power output appears reassuring. Wind timing supports this wind claim.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Consume additional structural life because the turbine continues generating and has not reached an automatic trip. Wind practice makes the wind view plausible. Wind timing supports this wind claim.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
    ...
    "wd_ewing": {
      ...
      "frame": "Blade Tech Aro steadies a blade photograph at The Operator's Asset Office. \"Use James Alfred Ewing to connect wind loading with the cycles this rotor carried.\"",
      "q": [
        {
    ...
    "wd_gough": {
      "sci": "Herbert J. Gough (1890-1965)",
      "topic": "Metal fatigue research",
      "lede": "Through metal fatigue research, Herbert J. Gough connected useful rotor motion with structural endurance.",
      "no": 14,
      "profile": "This rotating-machinery cover note tracks Herbert J. Gough through metal fatigue research. Herbert J. Gough led systematic research on metal fatigue, including combined stresses, surface condition, size effects, and endurance testing. His work helped turn fatigue from a mysterious breakage into a measurable design problem. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nLaboratory fatigue data must be adjusted for real geometry, environment, manufacturing defects, and variable-amplitude service loads. Fatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nControl systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. A wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nAn asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems. Cover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking. The design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits.",
      "frame": "Blade Tech Aro freezes a vibration trace at The Operator's Asset Office. \"Explain metal fatigue research without pretending one gust tells the whole fatigue history.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Herbert J. Gough's work on metal fatigue research?",
          "o": [
            {
              "t": "Herbert J. Structural review keeps the raw cycle spectrum available for assessment. Rotor analysts compare the raw cycle spectrum with cyclic loading. Fatigue evidence ties the raw cycle spectrum to remaining life.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Herbert J. Gough's wind work emphasizes average load and current power output. The latest inspection looks acceptable. A single gust fits the event. Wind records fit this wind account. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Herbert J. Gough's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. Power output appears reassuring. Wind timing supports this wind claim.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Herbert J. Gough's authority is invoked in wind practice to justify muting vibration alarms when shutdown would sacrifice a productive wind period. Power output appears reassuring. Wind records fit this wind account.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Laboratory fatigue data must be adjusted for real geometry, environment, manufacturing defects, and variable-amplitude service loads. The turbine dossier carries the blade-root finding. Wind fits.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
            ...
            {
              "t": "Consume additional structural life because the turbine continues generating and has not reached an automatic trip. The latest inspection looks acceptable. Wind records fit this wind account.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
    ...
    "wd_palmgren": {
      ...
      "frame": "The SCADA Operator sets a cracked fastener on the table at The Operator's Asset Office. \"Start with Arvid Palmgren; end with what should have been measured.\"",
      "q": [
        {
    ...
    "wd_miner": {
      "sci": "Milton A. Miner (fatigue engineer)",
      "topic": "Cumulative fatigue damage",
      "lede": "Milton A. Miner tied cumulative fatigue damage to the repeated loads carried by real wind machines.",
      "no": 16,
      "profile": "This rotating-machinery cover note tracks Milton A. Miner through cumulative fatigue damage. Milton Miner formalized the linear cumulative-damage rule often called Palmgren-Miner damage. The fractions of life used at different stress levels are added, with failure expected near a total of one. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nCumulative damage is a screening model, not a guarantee; load order, mean stress, environment, and crack growth can violate its assumptions. A wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nFatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. Control systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nMiner's cumulative-damage rule helps read a bolted hub joint. Bolts depend on preload to keep fluctuating external loads from becoming large stress cycles in the fasteners; lost clamp force permits slip, fretting, and repeated tensile loading. Several bolts can then accumulate fatigue at different rates until the remaining group overloads. Torque records, fretting around holes, and multiple fatigue origins support joint separation from preload loss rather than one blade crack or a resonant tower mode.",
      "frame": "The SCADA Operator steadies a blade photograph at The Operator's Asset Office. \"Use Milton A. Miner to connect wind loading with the cycles this rotor carried.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Milton A. Miner's work on cumulative fatigue damage?",
          "o": [
            {
              "t": "Milton Miner formalized the linear cumulative-damage rule often called Palmgren-Miner damage. Rotor analysts compare the raw structurally interpreted rotor vibration trend with cyclic loading.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Milton A. Miner's wind work emphasizes average load and current power output. Power output appears reassuring. The latest inspection looks acceptable. Wind practice makes the wind view plausible.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Milton A. Miner's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. The latest inspection looks acceptable. Wind fits.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Milton A. Miner's wind authority supports muting vibration alarms when shutdown would sacrifice a productive wind period. Power output appears reassuring. Wind practice makes the wind view plausible.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Cumulative damage is a screening model, not a guarantee; load order, mean stress, environment, and crack growth can violate its assumptions. The turbine dossier carries the cycle spectrum.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Use one gust or average load while treating the variable-amplitude cycle history as a later engineering refinement. The latest inspection looks acceptable. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Assume lift, resonance, and fatigue resistance remain stable across yaw, turbulence, surface damage, and operating speed. The latest inspection looks acceptable. Wind timing supports this wind claim.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Consume additional structural life because the turbine continues generating and has not reached an automatic trip. The latest inspection looks acceptable. Wind timing supports this wind claim.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
    ...
    "wd_paris": {
      ...
      "frame": "The Clerk freezes a vibration trace at The Operator's Asset Office. \"Explain fatigue crack growth without pretending one gust tells the whole fatigue history.\"",
      "q": [
        {
    ...
    "wd_stribeck": {
      ...
      "lede": "Richard Stribeck's work on bearing friction & lubrication made wind, vibration, or fatigue an engineering quantity.",
      "no": 18,
      "profile": "This rotating-machinery cover note tracks Richard Stribeck through bearing friction & lubrication. Richard Stribeck studied friction in lubricated bearings and showed how friction changes with viscosity, speed, and load. The Stribeck curve distinguishes boundary, mixed, and full-film lubrication regimes. The contribution joined wind, motion, stress, or wear to a calculation that could be tested against a machine's repeated service cycles.\n\nA bearing can move from protective fluid-film lubrication into damaging contact when speed, temperature, viscosity, or load changes. Control systems can reduce loads, yet muted alarms and extended operation alter the damage calculation. A turbine that continues producing power may be consuming structural life much faster than the revenue display suggests. A wind-engineering explanation should state the aerodynamic input, structural response, cycle count, material limit, and observation used to judge remaining life.\n\nA wind turbine lives under millions of variable-amplitude cycles. Wind shear, turbulence, yaw error, gravity, pitching, braking, and grid events repeatedly load blades, hub bolts, bearings, shafts, and tower joints. Fatigue is cumulative and often invisible until a crack becomes large. SCADA trends, vibration spectra, oil debris, bolt checks, blade imaging, acoustic methods, and load history each see a different part of the deterioration. The turbine history should unite wind events, vibration, controller actions, blade images, bolt torque, bearing findings, and every maintenance deferral.\n\nCover expertise here is the ability to read a fracture surface and an alarm trend as parts of the same timeline. Sabotage and gust stories should not outrun evidence of progressive cracking. The design lesson is to connect aerodynamic performance with structural endurance. The most efficient rotor is not a safe machine unless its real load spectrum remains inside inspected and maintainable limits. An asset history should preserve storms, shutdowns, vibration excursions, repairs, torque records, blade findings, and deferred work. Fatigue assessment becomes weak when these are scattered across contractors and software systems.",
      "frame": "The Clerk sets a cracked fastener on the table at The Operator's Asset Office. \"Start with Richard Stribeck; end with what should have been measured.\"",
      "q": [
        {
          "q": "Which wind-and-fatigue account best represents Richard Stribeck's work on bearing friction & lubrication?",
          "o": [
            {
              "t": "Richard Stribeck studied friction in lubricated bearings and showed how friction changes with viscosity, speed, and load. The turbine dossier carries the turbine-specific cycle spectrum.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Richard Stribeck's wind work emphasizes average load and current power output. The latest inspection looks acceptable. Wind context supports the view. Wind timing supports this wind claim.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Richard Stribeck's wind work supports normal power production as sufficient evidence that blades, bolts, bearings, and tower joints remain sound. Wind practice makes the wind view plausible.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Richard Stribeck's wind authority supports muting vibration alarms when shutdown would sacrifice a productive wind period. A single gust fits the event. Wind records fit this wind account.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A bearing can move from protective fluid-film lubrication into damaging contact when speed, temperature, viscosity, or load changes. The turbine dossier carries the cycle spectrum.",
              "v": "expert",
              "fb": "Correct: the answer links aerodynamic loading with cumulative damage, inspection, and control response."
            },
            {
              "t": "Use one gust or average load while treating the variable-amplitude cycle history as a later engineering refinement. Power output appears reassuring. Wind records fit this wind account.",
              "v": "partial",
              "fb": "This recognizes one load or component but omits the repeated-cycle or monitoring evidence."
            },
            {
              "t": "Assume lift, resonance, and fatigue resistance remain stable across yaw, turbulence, surface damage, and operating speed. Power output appears reassuring. Wind records fit this wind account.",
              "v": "wrong",
              "fb": "That explanation mistakes a power or wind value for a complete structural assessment."
            },
            {
              "t": "Consume additional structural life because the turbine continues generating and has not reached an automatic trip. Wind context supports the view. Wind timing supports this wind claim.",
              "v": "danger",
              "fb": "That choice keeps production visible while silencing the signals that structural life is being consumed."
            }
          ]
  ...
  "story": [
    "<b>Rotor fragments lie in a surveyed field while the remaining tower is held by temporary guys.</b>",
    "To reconstruct fracture surfaces, question <b>Blade Tech Aro</b> about components, <b>The SCADA Operator</b> about operation, and <b>The Clerk</b> about deferred work.",
    "Three possible owners remain—Sylvie Renn — wind-farm operator, The turbine service lead, The turbine safety regulator. Neither <b>A blade-root fatigue crack grew through repeated bending cycles</b> nor <b>Tower resonance amplified vibration until the support buckled</b> can be dismissed without understanding fracture surfaces.",
    "<b>Recovery cranes arrive in eight days, after which bolt positions and fracture relationships will be disturbed.</b>"
  ],
  "endings": {
