module.exports = { PACK: {
  ...
  "TOPICS": {
    "ether": {
      ...
      "frame": "Nurse Beale checks the monitor at The Operating Theatre. \"Explain what Crawford Long changed, and keep the patient's breathing in the answer.\"",
      "q": [
        {
    ...
    "etherday": {
      "sci": "William T.G. Morton (1819-1868)",
      "topic": "The public ether demonstration",
      "lede": "Through the public ether demonstration, William T.G. Morton changed anesthesia from bold dosing into observable clinical control.",
      "no": 2,
      "profile": "This morning's anesthesia cover email follows William T.G. Morton through the public ether demonstration. William T. G. Morton arranged the 1846 public ether demonstration at Massachusetts General Hospital, where surgeon John Collins Warren removed a neck tumor while the patient was insensible. The event made inhaled anesthesia visible to physicians far beyond one local practice. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nA public success can spread a technique, but repeatable delivery, dose control, equipment, and monitoring determine whether it becomes safe routine care. The modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nHuman-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. Anesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nA safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment. Cover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation. The distinction comes from pharmacology, monitor traces, equipment checks, and the chronology of response. The durable lesson is that vigilance is an organized practice, not a personality trait.",
      "frame": "Nurse Beale turns a vial beneath the light at The Operating Theatre. \"Use the public ether demonstration to show me the effect, the measurement, and the rescue path.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes William T.G. Morton's work on the public ether demonstration?",
          "o": [
            {
              "t": "William T. Perioperative evidence keeps the drug record audible or reviewable. Anesthesia review links the drug record to the response. Anesthesia review links the raw drug record to the response. Context fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "William T.G. Morton's anesthesia work relies on clinical experience and one reassuring sign. The patient first appears stable. Team experience seems reassuring. The routine workflow supports it. Context fits.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "William T.G. Morton's anesthesia work is read within anesthesia practice as support for experience alone as sufficient control of anesthesia without independent measured physiology. The patient first appears stable.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "William T.G. Morton's authority is invoked in anesthesia practice to justify muting an alarm or skipping a check when the patient initially appears stable. Anesthesia timing supports this anesthesia claim.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A public success can spread a technique, but repeatable delivery, dose control, equipment, and monitoring determine whether it becomes safe routine care. The clinical file retains the drug record.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "nitrous": {
      ...
      "frame": "The Biomed Tech pauses beside the anesthesia cart at The Operating Theatre. \"I need physiology, not legend. Start with Horace Wells.\"",
      "q": [
        {
    ...
    "chloroform": {
      "sci": "James Young Simpson (1811-1870)",
      "topic": "Chloroform anesthesia",
      "lede": "James Young Simpson made chloroform anesthesia part of the measured physiology surrounding unconscious patients.",
      "no": 4,
      "profile": "This morning's anesthesia cover email follows James Young Simpson through chloroform anesthesia. James Young Simpson introduced chloroform into obstetric and surgical practice after testing volatile agents with colleagues in Edinburgh. Chloroform acted rapidly and was easier to carry than ether, but its narrow safety margin and cardiac toxicity made careful administration essential. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nConvenience never cancels pharmacologic risk, especially when a potent agent can depress the heart or breathing without much warning. Anesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nThe modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. Human-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nThe durable lesson is that vigilance is an organized practice, not a personality trait. Standard setup, independent confirmation, audible alarms, and clear escalation preserve the few minutes in which physiology can still be rescued. A safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment. Cover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation.",
      "frame": "The Biomed Tech checks the monitor at The Operating Theatre. \"Explain what James Young Simpson changed, and keep the patient's breathing in the answer.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes James Young Simpson's work on chloroform anesthesia?",
          "o": [
            {
              "t": "James Young Simpson introduced chloroform into obstetric and surgical practice after testing volatile agents with colleagues in Edinburgh. The clinical file retains the raw independent monitor trace. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "James Young Simpson's anesthesia work emphasizes clinical experience and one reassuring sign. The patient first appears stable. Team experience seems reassuring. The routine workflow supports it. Anesthesia fits.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "James Young Simpson's anesthesia work is read within anesthesia practice as support for experience alone as sufficient control of anesthesia without independent measured physiology. The patient first appears stable.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "James Young Simpson's authority is invoked in anesthesia practice to justify muting an alarm or skipping a check when the patient initially appears stable. Anesthesia practice makes the anesthesia view plausible.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Convenience never cancels pharmacologic risk, especially when a potent agent can depress the heart or breathing without much warning. The clinical file retains the monitor trace. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "inhaler": {
      ...
      "frame": "The Clerk turns a vial beneath the light at The Operating Theatre. \"Use the chloroform inhaler & patient safety to show me the effect, the measurement, and the rescue path.\"",
      "q": [
        {
    ...
    "spinal": {
      "sci": "August Bier (1861-1949)",
      "topic": "Spinal anesthesia",
      "lede": "August Bier's work on spinal anesthesia gave operating teams a clearer sign, tool, or stopping point.",
      "no": 6,
      "profile": "This morning's anesthesia cover email follows August Bier through spinal anesthesia. August Bier performed early spinal anesthesia in 1898 by injecting cocaine into the subarachnoid space, then famously tested the block with his assistant August Hildebrandt. Severe post-dural-puncture headaches followed, revealing both the power and the hazards of neuraxial technique. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nRegional anesthesia depends on anatomy, sterile technique, dose, physiologic monitoring, and readiness to manage complications. Human-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nAnesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. The modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nCover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation. The distinction comes from pharmacology, monitor traces, equipment checks, and the chronology of response. The durable lesson is that vigilance is an organized practice, not a personality trait. Standard setup, independent confirmation, audible alarms, and clear escalation preserve the few minutes in which physiology can still be rescued. A safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment.",
      "frame": "The Clerk pauses beside the anesthesia cart at The Operating Theatre. \"I need physiology, not legend. Start with August Bier.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes August Bier's work on spinal anesthesia?",
          "o": [
            {
              "t": "August Bier performed early spinal anesthesia in 1898 by injecting cocaine into the subarachnoid space, then famously tested the block with his assistant August Hildebrandt. The clinical file retains the drug record. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "August Bier's anesthesia work relies on clinical experience and one reassuring sign. The patient first appears stable. Team experience seems reassuring. The routine workflow supports it. The patient first appears stable. Anesthesia fits.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "August Bier's anesthesia work supports experience alone as sufficient control of anesthesia without independent measured physiology. Anesthesia practice makes the anesthesia view plausible. Anesthesia timing supports this anesthesia claim.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "August Bier's authority is invoked in anesthesia practice to justify muting an alarm or skipping a check when the patient initially appears stable. Team experience seems reassuring. The routine workflow supports it. Anesthesia fits.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Regional anesthesia depends on anatomy, sterile technique, dose, physiologic monitoring, and readiness to manage complications. The clinical file retains the raw alarm response. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "depth": {
      ...
      "frame": "Nurse Beale checks the monitor at The Drug Room & Vial Store. \"Explain what Arthur Guedel changed, and keep the patient's breathing in the answer.\"",
      "q": [
        {
    ...
    "circuit": {
      "sci": "Ralph Waters (1883-1979)",
      "topic": "Closed-circuit anesthesia & CO2 absorption",
      "lede": "Through closed-circuit anesthesia & CO2 absorption, Ralph Waters changed anesthesia from bold dosing into observable clinical control.",
      "no": 8,
      "profile": "This morning's anesthesia cover email follows Ralph Waters through closed-circuit anesthesia & CO2 absorption. Ralph Waters helped establish academic anesthesiology and advanced closed-circuit techniques that reused anesthetic gases after carbon dioxide absorption. The approach conserved agent and heat, but it made absorber function, valve integrity, fresh-gas flow, and leak testing central to safety. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nA closed system gains efficiency only when every hidden component is checked and the patient's exhaled carbon dioxide is reliably removed. The modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nHuman-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. Anesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nA safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment. Cover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation. The distinction comes from pharmacology, monitor traces, equipment checks, and the chronology of response. The durable lesson is that vigilance is an organized practice, not a personality trait.",
      "frame": "Nurse Beale turns a vial beneath the light at The Drug Room & Vial Store. \"Use closed-circuit anesthesia & CO2 absorption to show me the effect, the measurement, and the rescue path.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes Ralph Waters's work on closed-circuit anesthesia & CO2 absorption?",
          "o": [
            {
              "t": "Ralph Waters helped establish academic anesthesiology and advanced closed-circuit techniques that reused anesthetic gases after carbon dioxide absorption. The clinical file retains the raw drug record. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "Ralph Waters's anesthesia work relies on clinical experience and one reassuring sign. Anesthesia records fit this anesthesia account. Anesthesia context supports the view. Anesthesia timing supports this anesthesia claim.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "Ralph Waters's anesthesia work is read within anesthesia practice as support for experience alone as sufficient control of anesthesia without independent measured physiology. Anesthesia timing supports this anesthesia claim.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "Ralph Waters's anesthesia authority supports muting an alarm or skipping a check when the patient initially appears stable. Anesthesia records fit this anesthesia account. Anesthesia timing supports this anesthesia claim.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A closed system gains efficiency only when every hidden component is checked and the patient's exhaled carbon dioxide is reliably removed. The anesthesia chart preserves the alarm response. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "machine": {
      ...
      "frame": "The Biomed Tech pauses beside the anesthesia cart at The Drug Room & Vial Store. \"I need physiology, not legend. Start with Elmer McKesson.\"",
      "q": [
        {
    ...
    "intubation": {
      "sci": "Ivan Magill (1888-1986)",
      "topic": "Endotracheal intubation",
      "lede": "Ivan Magill made endotracheal intubation part of the measured physiology surrounding unconscious patients.",
      "no": 10,
      "profile": "This morning's anesthesia cover email follows Ivan Magill through endotracheal intubation. Ivan Magill refined endotracheal intubation during reconstructive surgery for facial injuries after the First World War. Magill forceps, breathing systems, and practical airway techniques made it possible to separate the surgical field from the route used to ventilate the lungs. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nSecuring an airway is a controlled sequence: preparation, visualization, tube placement, confirmation, fixation, and continued ventilation checks. Anesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nThe modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. Human-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nMagill's endotracheal technique supplies the decisive airway test. A tube in the trachea delivers ventilation to alveoli and produces a sustained end-tidal carbon-dioxide waveform; a tube in the esophagus may move the chest or fog briefly yet yields no continuing CO2 and leads to progressive hypoxemia. Direct visualization, capnography, and oxygen trend together discriminate esophageal intubation from excessive anesthetic depth or anaphylaxis.",
      "frame": "The Biomed Tech checks the monitor at The Drug Room & Vial Store. \"Explain what Ivan Magill changed, and keep the patient's breathing in the answer.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes Ivan Magill's work on endotracheal intubation?",
          "o": [
            {
              "t": "Ivan Magill refined endotracheal intubation during reconstructive surgery for facial injuries after the First World War. Anesthesia review links the raw independent drug record to the response. Fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "Ivan Magill's anesthesia work emphasizes clinical experience and one reassuring sign. Team experience seems reassuring. The routine workflow supports it. Anesthesia records fit this anesthesia account.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "Ivan Magill's anesthesia work is read within anesthesia practice as support for experience alone as sufficient control of anesthesia without independent measured physiology. The routine workflow supports it.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "Ivan Magill's anesthesia authority supports muting an alarm or skipping a check when the patient initially appears stable. Team experience seems reassuring. The routine workflow supports it. Fits.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Securing an airway is a controlled sequence: preparation, visualization, tube placement, confirmation, fixation, and continued ventilation checks. The clinical file retains the drug record. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "laryngoscope": {
      ...
      "frame": "The Clerk turns a vial beneath the light at The Drug Room & Vial Store. \"Use the laryngoscope to show me the effect, the measurement, and the rescue path.\"",
      "q": [
        {
    ...
    "relaxant": {
      "sci": "Harold Griffith (1894-1985)",
      "topic": "Curare & muscle relaxants",
      "lede": "Harold Griffith's work on curare & muscle relaxants gave operating teams a clearer sign, tool, or stopping point.",
      "no": 12,
      "profile": "This morning's anesthesia cover email follows Harold Griffith through curare & muscle relaxants. Harold Griffith and Enid Johnson reported the clinical use of curare during anesthesia in 1942. Neuromuscular blockade allowed profound muscle relaxation without requiring dangerously deep anesthesia, but it also removed spontaneous breathing and made assisted ventilation indispensable. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nParalysis can hide movement without providing unconsciousness or analgesia, so drug effects must be separated and monitored deliberately. Human-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nAnesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. The modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nGriffith's introduction of curare also illuminates acute drug reactions. Neuromuscular blockers are among agents capable of severe anaphylaxis, which usually appears abruptly after administration with hypotension, bronchospasm, flushing, rash, or edema. The reaction can be catastrophic despite an otherwise correct airway. Its timing and systemic signs differ from a steady fall in oxygen accompanied by absent exhaled carbon dioxide and uncomplicated drug dosing.",
      "frame": "The Clerk pauses beside the anesthesia cart at The Drug Room & Vial Store. \"I need physiology, not legend. Start with Harold Griffith.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes Harold Griffith's work on curare & muscle relaxants?",
          "o": [
            {
              "t": "Harold Griffith and Enid Johnson reported the clinical use of curare during anesthesia in 1942. Clinicians compare the time-stamped patient-linked monitor trace with the patient's course. Anesthesia fits. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "Harold Griffith's anesthesia work relies on clinical experience and one reassuring sign. The patient first appears stable. Team experience seems reassuring. The patient first appears stable. Anesthesia fits. Anesthesia fits.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "Harold Griffith's anesthesia work supports experience alone as sufficient control of anesthesia without independent measured physiology. Anesthesia practice makes the anesthesia view plausible. The anesthesia record fits.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "Harold Griffith's authority is invoked in anesthesia practice to justify muting an alarm or skipping a check when the patient initially appears stable. The routine workflow supports it. Anesthesia fits. Anesthesia fits.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Paralysis can hide movement without providing unconsciousness or analgesia, so drug effects must be separated and monitored deliberately. The clinical file retains the drug record. Anesthesia fits. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
            ...
            {
              "t": "Remove a verification step because interruptions slow a familiar and heavily scheduled operating list. Anesthesia context supports the view. Anesthesia timing supports this anesthesia claim. Anesthesia fits.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
    ...
    "apgar": {
      ...
      "frame": "Nurse Beale checks the monitor at The Center's Administration Office. \"Explain what Virginia Apgar changed, and keep the patient's breathing in the answer.\"",
      "q": [
        {
    ...
    "mortality": {
      "sci": "Henry Beecher (1904-1976)",
      "topic": "Anesthesia mortality & research ethics",
      "lede": "Through anesthesia mortality & research ethics, Henry Beecher changed anesthesia from bold dosing into observable clinical control.",
      "no": 14,
      "profile": "This morning's anesthesia cover email follows Henry Beecher through anesthesia mortality & research ethics. Henry Beecher studied anesthesia deaths and argued that outcomes depended heavily on systems of training, vigilance, and technique rather than on drugs alone. He also exposed unethical human experimentation, helping place informed consent and independent ethical review at the center of research. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nSafety data must be collected honestly, and neither technical prestige nor institutional pressure excuses avoidable risk to patients or research participants. The modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nHuman-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. Anesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nA safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment. Cover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation. The distinction comes from pharmacology, monitor traces, equipment checks, and the chronology of response. The durable lesson is that vigilance is an organized practice, not a personality trait.",
      "frame": "Nurse Beale turns a vial beneath the light at The Center's Administration Office. \"Use anesthesia mortality & research ethics to show me the effect, the measurement, and the rescue path.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes Henry Beecher's work on anesthesia mortality & research ethics?",
          "o": [
            {
              "t": "Henry Beecher studied anesthesia deaths and argued that outcomes depended heavily on systems of training, vigilance, and technique rather than on drugs alone. The clinical file retains the drug record. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "Henry Beecher's anesthesia work emphasizes clinical experience and one reassuring sign. One clinical sign looks sufficient. Anesthesia records fit this anesthesia account. Anesthesia timing supports this anesthesia claim.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "Henry Beecher's anesthesia work is read within anesthesia practice as support for experience alone as sufficient control of anesthesia without independent measured physiology. Anesthesia timing supports this anesthesia claim.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "Henry Beecher's anesthesia authority supports muting an alarm or skipping a check when the patient initially appears stable. Anesthesia records fit this anesthesia account. Anesthesia timing supports this anesthesia claim.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Safety data must be collected honestly, and neither technical prestige nor institutional pressure excuses avoidable risk to patients or research participants. The clinical file retains the drug record.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "bloodgas": {
      ...
      "frame": "The Biomed Tech pauses beside the anesthesia cart at The Center's Administration Office. \"I need physiology, not legend. Start with John Severinghaus.\"",
      "q": [
        {
    ...
    "oximetry": {
      "sci": "Takuo Aoyagi (1936-2020)",
      "topic": "Pulse oximetry",
      "lede": "Takuo Aoyagi made pulse oximetry part of the measured physiology surrounding unconscious patients.",
      "no": 16,
      "profile": "This morning's anesthesia cover email follows Takuo Aoyagi through pulse oximetry. Takuo Aoyagi discovered that pulsatile changes in light absorption could isolate arterial blood from surrounding tissue, enabling practical pulse oximetry. The technique transformed anesthesia by providing continuous, noninvasive warning of falling oxygen saturation. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nContinuous monitoring creates time to intervene only if the alarm is audible, the signal is credible, and someone is responsible for responding. Anesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nThe modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. Human-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nThe durable lesson is that vigilance is an organized practice, not a personality trait. Standard setup, independent confirmation, audible alarms, and clear escalation preserve the few minutes in which physiology can still be rescued. A safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment. Cover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation. The distinction comes from pharmacology, monitor traces, equipment checks, and the chronology of response.",
      "frame": "The Biomed Tech checks the monitor at The Center's Administration Office. \"Explain what Takuo Aoyagi changed, and keep the patient's breathing in the answer.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes Takuo Aoyagi's work on pulse oximetry?",
          "o": [
            {
              "t": "Takuo Aoyagi discovered that pulsatile changes in light absorption could isolate arterial blood from surrounding tissue, enabling practical pulse oximetry. The clinical file retains the raw independent monitor trace. Anesthesia fits. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "Takuo Aoyagi's anesthesia work emphasizes clinical experience and one reassuring sign. Anesthesia context supports the view. Anesthesia practice makes the anesthesia view plausible. Anesthesia timing supports this anesthesia claim. The anesthesia record fits.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "Takuo Aoyagi's anesthesia work supports experience alone as sufficient control of anesthesia without independent measured physiology. Anesthesia practice makes the anesthesia view plausible. Anesthesia timing supports this anesthesia claim. Anesthesia fits.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "Takuo Aoyagi's authority is invoked in anesthesia practice to justify muting an alarm or skipping a check when the patient initially appears stable. Team experience seems reassuring. The patient first appears stable. Anesthesia fits. Anesthesia fits.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "Continuous monitoring creates time to intervene only if the alarm is audible, the signal is credible, and someone is responsible for responding. The clinical file retains the drug record. Anesthesia fits. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
    ...
    "mishaps": {
      ...
      "frame": "The Clerk turns a vial beneath the light at The Center's Administration Office. \"Use anesthesia mishaps & human factors to show me the effect, the measurement, and the rescue path.\"",
      "q": [
        {
    ...
    "apsf": {
      "sci": "Ellison Pierce (anesthesiologist, 1929-2011)",
      "topic": "The anesthesia patient-safety movement",
      "lede": "Ellison Pierce's work on the anesthesia patient-safety movement gave operating teams a clearer sign, tool, or stopping point.",
      "no": 18,
      "profile": "This morning's anesthesia cover email follows Ellison Pierce through the anesthesia patient-safety movement. Ellison Pierce helped found the Anesthesia Patient Safety Foundation in 1985 after preventable anesthesia injuries drew national concern. The foundation promoted monitoring standards, incident learning, research, and collaboration among clinicians, engineers, manufacturers, and regulators. Its lasting importance is clinical: an observed effect became a controllable practice that colleagues could test at the bedside.\n\nA safety movement succeeds when it turns individual vigilance into shared standards, transparent reporting, and engineered barriers. Human-factors design matters because alarms, connectors, vials, and handoffs compete for attention. A safeguard that is routinely muted or bypassed has ceased to be a safeguard, even if the machine still looks normal. An anesthetic explanation should name the drug or device, the physiologic variable watched, the expected change, and the response threshold.\n\nAnesthesia is a controlled disturbance of consciousness, pain, movement, breathing, and circulation. Because several drug effects overlap without being identical, the clinician must know which function is intentionally changed and which one is silently failing. The modern safety chain combines preoperative assessment, labeled drugs, checked equipment, oxygenation, ventilation, circulation, temperature, neuromuscular monitoring, and a trained person who remains present. No single display can represent the whole patient. The anesthesia timeline should retain monitor values, alarm state, doses, airway events, equipment configuration, and interventions in the order they occurred.\n\nCover knowledge in this field means recognizing the difference between a rare reaction and a predictable gap in observation. The distinction comes from pharmacology, monitor traces, equipment checks, and the chronology of response. The durable lesson is that vigilance is an organized practice, not a personality trait. Standard setup, independent confirmation, audible alarms, and clear escalation preserve the few minutes in which physiology can still be rescued. A safe anesthetic record should explain what was given, what was measured, how values changed, and what response followed. That timeline allows teams to learn from deviations rather than reduce an event to one dramatic moment.",
      "frame": "The Clerk pauses beside the anesthesia cart at The Center's Administration Office. \"I need physiology, not legend. Start with Ellison Pierce.\"",
      "q": [
        {
          "q": "Which anesthesia history best describes Ellison Pierce's work on the anesthesia patient-safety movement?",
          "o": [
            {
              "t": "Ellison Pierce helped found the Anesthesia Patient Safety Foundation in 1985 after preventable anesthesia injuries drew national concern. Clinicians compare the drug record with the patient's course. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
              "t": "Ellison Pierce's anesthesia work relies on clinical experience and one reassuring sign. The routine workflow supports it. Anesthesia records fit this anesthesia account. Anesthesia timing supports this anesthesia claim.",
              "v": "partial",
              "fb": "This captures part of the technique but leaves an important measurement or safety dependency unresolved."
            },
            {
              "t": "Ellison Pierce's anesthesia work is read within anesthesia practice as support for experience alone as sufficient control of anesthesia without independent measured physiology. The routine workflow supports it. Anesthesia fits.",
              "v": "wrong",
              "fb": "That account assigns the wrong mechanism or treats a technical advance as permission to ignore its limits."
            },
            {
              "t": "Ellison Pierce's anesthesia authority supports muting an alarm or skipping a check when the patient initially appears stable. The routine workflow supports it. Anesthesia records fit this anesthesia account. Context fits.",
              "v": "danger",
              "fb": "That shortcut removes a protective barrier precisely when the patient's condition may change without visible warning."
            }
          ]
        },
        {
          ...
          "o": [
            {
              "t": "A safety movement succeeds when it turns individual vigilance into shared standards, transparent reporting, and engineered barriers. The clinical file retains the monitor trace. Anesthesia fits.",
              "v": "expert",
              "fb": "Correct: the answer connects the historical contribution with controlled delivery, monitoring, and timely response."
            },
            {
  ...
  "story": [
    "<b>The operating theatre remains sealed, with the anesthesia record displayed beside untouched airway equipment.</b>",
    "<b>Nurse Beale</b> remembers the theatre, <b>The Biomed Tech</b> understands the airway waveform equipment, and <b>The Clerk</b> controls the administrative record.",
    "The responsible figure is one of Dr. Payne — the anesthetist on the case, Lorne Halden — the surgical center's director, or The drug-supply rep. The physiological dispute contrasts <b>Excess anesthetic depth suppressed circulation despite a patent airway</b> with <b>Anaphylaxis caused abrupt hypotension after the induction drug</b>.",
    "<b>The center's license hearing opens in eight days, and the original monitor data must be interpreted before testimony hardens.</b>"
  ],
  "endings": {
