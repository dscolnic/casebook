...
export const CHARACTER_DIVISION={
  oppenheimer:'T', bethe:'T', vonneumann:'T', ulm:'T', meitner:'T', mayer:'T', fuchs:'T', hall:'T', szilard:'T',
  fermi:'P', bacher:'P', woods:'P', wu:'P', hinton:'P', graves:'P', lawrence:'P', chadwick:'P',
  seaborg:'CM', hornig:'CM', kitty:'CM',
  groves:'E', parsons:'E', bradbury:'E', mckibbin:'E',
  kistiakowsky:'X', greenglass:'X'
};
export function divisionForCharacter(charId){ return CHARACTER_DIVISION[charId] || 'T'; }
export const PERSONS_BY_DIVISION={
  T: ['bethe','vonneumann','ulm','meitner','mayer','fuchs','hall','szilard'],
  P: ['fermi','bacher','woods','wu','hinton','graves','lawrence','chadwick'],
  CM: ['seaborg','hornig','kitty'],
  E: ['parsons','bradbury','mckibbin','groves'],
  X: ['kistiakowsky','greenglass']
};
