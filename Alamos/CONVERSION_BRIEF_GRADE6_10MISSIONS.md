...
## 0. Grade-6 override for this pass
...
- Keep the first-person planetary-defense mission and the real science setting.
...
8. **Keep the reading level, and here is how.** Each game states an audience
   grade in its manifest — **5 for this pass**. Anything more than two grades over is
   ...
   - **Vocabulary and concept load both matter at grade 5.** Keep a technical
