...
// The single shared slot these two names refer to predates per-theme keys. They
// are read once so an in-progress campaign survives the change, then written
// forward under the theme's own key.
const LEGACY_KEYS = ['hospitalHeroes_juniorDoctor_v1'];
