...
export const MISSIONS = [
  ...
  },
  {
    ...
    "stake": "Day thirty-three. Sequences from three patients sit close to a virus found in animals along the river, and the council has signed an order to clear the heron colony on Saturday. Castellanos has been out there twice and says the herons are the wrong animal; Singh will not say either way until the sampling is designed properly. This stage you decide what role any animal is actually playing and design the campaign that could show it. Three roles get confused. A reservoir carries the agent long term and stays well enough to keep carrying it. A vector moves it between hosts without being where it lives. A dead-end host catches it and passes it to nobody. Those are claims about who infects whom over time, not about which animal is nearby or easiest to blame.",
