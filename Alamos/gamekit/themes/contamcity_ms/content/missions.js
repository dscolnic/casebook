...
export const MISSIONS = [
  ...
  },
  {
    ...
    "stake": "Day eleven. The fire has been out for eight days, and one storage bay is still getting warmer. Tomas Brandt, the reactions & energy lead, has been reading it every hour since midnight. Fire Command wants the site released tonight, and the crews have been on shift for fourteen hours. Today you decide whether this is leftover heat or a reaction still running, and set up the watching either way. One reading cannot tell you which.",
...
export const WARMUPS = {
  "greet": {
    "title": "Six offices in one city, and nobody has met",
    "why": "The city laboratory, the water company and the health office all take part of this job. By Friday one of them has to sign for another's number. Put a name to as many of them as you can now, because a signature you cannot picture is one you check twice."
  },
  "trial-near": {
    "title": "Walk the river bank before you take a sample",
    "why": "The city sits along the river, and every sample means something different depending on where the water was standing. Walk the near bank once. A map does not show you which outfall is above which bridge."
  },
  "follow": {
    "title": "Adeyemi walks a bottle from the bank to the bench",
    "why": "A water sample is taken, cooled, carried and logged before anybody measures it. Adeyemi walks one the whole way. Stay with her, and watch how long the bottle spends warm in the van."
  },
  "hunt": {
    "title": "Six sampling points, and four have markers",
    "item": {
      "name": "sampling point",
      "plural": "sampling points"
    },
    "why": "Every point on the river has to be found again next month or the numbers cannot be compared. Two markers are gone. A point nobody can find twice is a point that measures nothing."
  },
  "canvass": {
    "title": "Which streets are drinking the tap water",
    "why": "The exposure estimate assumes people stopped using the tap when they were told. Ask along the streets until enough answers have come back to say who stopped and who never got the notice."
  },
  "evade": {
    "title": "The builder who wants a clean result today",
    "why": "He has been outside the office since eight wanting the site declared clear. Nothing is declared anywhere except on the form, and the second run is not back. Keep clear of him and get your round done."
  },
  "tag": {
    "title": "Catch Okoye before the machine starts",
    "why": "Okoye has the list that says which bottles were blanks. Once the machine starts it runs for four hours. Without that list this morning's readings are numbers with no way to tell a real one from a clean one."
  }
};
