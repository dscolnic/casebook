...
export const MISSIONS = [
  ...
  },
  {
    ...
    "stake": "Day 38. The main plume cleared on Thursday and residents came home on Friday. Since then Varga's monitors climb every afternoon and drop overnight, and he has been ignored twice because the release is over. He has three fixed monitors, all of them on the yard fence, and one van. Today you work out what is forming out there and move the monitoring to where and when it could see it. Monitoring built for the release will keep reporting that the release is over, and it will be right. People are back in their houses with the windows open.",
