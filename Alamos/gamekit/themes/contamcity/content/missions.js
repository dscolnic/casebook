...
export const MISSIONS = [
  ...
  },
  {
    ...
    "stake": "Day nine, two o'clock in the morning. The fire has been out for eight days and one storage bay is still getting warmer. Tomas Brandt, who owns reactions and energy, has been reading it hourly since midnight. Fire Command wants the site released tonight and the crews have been on shift for fourteen hours. Today you work out how much energy it takes to warm that much material, decide whether you are watching leftover heat or a reaction still running, and set up the monitoring either way. The arithmetic is heat capacity: energy in, shared out over mass, gives the temperature rise, which tells you whether the warmth is even the right size for the story you were told. Telling the two apart takes a trend, not a reading. Stored heat fades. A reaction making its own heat does not.",
