...
export const VIEWS = [
  ...
  { name: 'specimen-store--doorway', at: { x: -3.3, y: 1.6, z: 7.5 }, yaw: WEST,
    note: 'across the specimen store, looking at the far wall' },
  { name: 'card-desk--doorway', at: { x: -3.3, y: 1.6, z: 30.5 }, yaw: WEST,
    note: 'across the card desk, looking at the far wall' },
  { name: 'analysis-bench--doorway', at: { x: 3.3, y: 1.6, z: 9.5 }, yaw: EAST,
    note: 'across the analysis bench, looking at the far wall' },
  { name: 'lecture-hall--doorway', at: { x: 3.3, y: 1.6, z: 26.5 }, yaw: EAST,
    note: 'across the lecture hall, looking at the far wall' },
];
