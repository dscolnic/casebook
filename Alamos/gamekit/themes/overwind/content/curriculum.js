...
export const CURRICULUM = {
  "BANK": [
    {
      "day": 1,
      "title": "Turn the faster ramp into a real ride",
      "scene": "At the top landing, Ubah, the banksman, lays the proposed acceleration curve beside the current one. The cage starts from rest, accelerates hardest at first, then tapers smoothly for twelve seconds. Before miners ride it, she needs to know where the cage is and how fast it is moving at the end.",
      "takeaway": "Integrating an acceleration gives a velocity, and integrating that gives a distance. Each integration needs its own starting value.",
      "place": "The Bank",
      "at": "profile-desk",
      ...
      "story": "At the top landing, Ubah, the banksman, lays the proposed acceleration curve beside the current one. The cage starts from rest, accelerates hardest at first, then tapers smoothly for twelve seconds. Before miners ride it, she needs to know where the cage is and how fast it is moving at the end.",
      "game": {
        "type": "DERIVE",
        "title": "Turn the faster ramp into a real ride",
        "setup": "The Bank",
        "play": "Turn the proposed acceleration curve into speed and distance",
        "task": "Turn the proposed acceleration curve into speed and distance",
        "question": "After twelve seconds of the proposed ramp, how fast is the cage moving and how far has it travelled?",
    ...
    {
      "day": 2,
      "title": "What did the March recorder actually see?",
      "scene": "At the bottom landing, Halloway, the onsetter, unrolls the March depth-recorder tape: one pen tracing cage position against time. The brake record watched the drum. This tape watched the cage. You need to pull every reliable fact from it before the two records are compared later.",
      ...
      "place": "The Bank",
      "at": "profile-desk",
      "guide": "Halloway is asking a fair question: how can one pen tell you four different things? Each thing the inquiry wanted has exactly one operation that would pull it out of a trace of position against time. The trick is knowing which direction to go. Differentiating takes a rate out of a position. Accumulating does the opposite, building a total out of a rate. One of the four is sitting on the paper already, with nothing left to do to it at all.",
      "story": "At the bottom landing, Halloway, the onsetter, unrolls the March depth-recorder tape: one pen tracing cage position against time. The brake record watched the drum. This tape watched the cage. You need to pull every reliable fact from it before the two records are compared later.",
      "game": {
        "type": "PROTOCOL",
        "title": "What did the March recorder actually see?",
        "setup": "The Bank",
        "play": "Match each fact in the March trace to what that one recorder can establish.",
        "task": "Match each fact in the March trace to what that one recorder can establish.",
        "question": "Match each fact in the March trace to what that one recorder can establish.",
        "answer": "",
    ...
    {
      "day": 3,
      "title": "How does the turning drum become cage motion?",
      "scene": "The rope does not slip on the drum. Every turn of the drum winds a known length of rope, so drum angle, angular speed, and angular acceleration each have a matching cage quantity. Ubah wants those pairs stated cleanly.",
      ...
      "story": "The rope does not slip on the drum. Every turn of the drum winds a known length of rope, so drum angle, angular speed, and angular acceleration each have a matching cage quantity. Ubah wants those pairs stated cleanly.",
      "game": {
        "type": "PROTOCOL",
        "title": "How does the turning drum become cage motion?",
        "setup": "The Bank",
        "play": "Match each drum reading to the cage motion it determines.",
        "task": "Match each drum reading to the cage motion it determines.",
        "question": "Match each drum reading to the cage motion it determines.",
        "answer": "",
    ...
    {
      "day": 4,
      "title": "Where does the motor need the most power?",
      "scene": "Just after the acceleration ramp, the cage is moving at 7.2 metres a second while 1,182 metres of rope still hang below the drum. The motor is turning quickly and still carrying almost the maximum load.",
      "takeaway": "The peak power of a wind is at the top of the ramp. The speed has arrived there, and the rope has not yet shortened.",
      "place": "The Bank",
      "at": "profile-desk",
      ...
      "story": "Just after the acceleration ramp, the cage is moving at 7.2 metres a second while 1,182 metres of rope still hang below the drum. The motor is turning quickly and still carrying almost the maximum load.",
      "game": {
        "type": "DERIVE",
        "title": "Where does the motor need the most power?",
        "setup": "The Bank",
        "play": "Find the motor power at the instant where high speed and high rope load overlap",
        "task": "Find the motor power at the instant where high speed and high rope load overlap",
        "question": "What power is the motor supplying at the end of the acceleration ramp?",
    ...
    {
      "day": 5,
      "title": "Why is the slow final crawl there?",
      "scene": "Every trip ends with a slow crawl into the landing. The cage is not simply trying to cover the last few metres; the rope and cage are settling after the earlier changes in speed. You decide what that time is buying.",
      "takeaway": "A margin that reads as caution is often a quantity somebody once computed and nobody wrote down.",
      "place": "The Bank",
      "at": "signal-board",
      "guide": "Ubah has watched this landing for years, and she has a fair question: what is that crawl actually buying? Look at each of the four answers and ask the same thing of it. Would a rigid steel bar need it too, or only twelve hundred metres of rope that bounces? A habit survives because nobody asks that question. A working margin survives because somebody once did, and wrote the answer down.",
      "story": "Every trip ends with a slow crawl into the landing. The cage is not simply trying to cover the last few metres; the rope and cage are settling after the earlier changes in speed. You decide what that time is buying.",
      "game": {
        "type": "CHOICE",
        "title": "Why is the slow final crawl there?",
        "setup": "The Bank",
        "play": "Explain the safety purpose of the slow final crawl",
        "task": "Explain the safety purpose of the slow final crawl",
        "question": "What is the slow crawl at the end of a trip actually doing?",
    ...
    {
      "day": 6,
      "title": "How much faster can Kerrow safely run?",
      "scene": "The final profile keeps the safe acceleration ramp and full speed, limits the speed before braking, and retains enough slow approach for the rope to settle. You integrate the pieces and compare the result with today's 184.3-second trip.",
      "takeaway": "A cycle time is only as good as the integral behind it. A saving that ignores a limit is not a saving.",
      "place": "The Bank",
      "at": "profile-desk",
      ...
      "story": "The final profile keeps the safe acceleration ramp and full speed, limits the speed before braking, and retains enough slow approach for the rope to settle. You integrate the pieces and compare the result with today's 184.3-second trip.",
      "game": {
        "type": "DERIVE",
        "title": "How much faster can Kerrow safely run?",
        "setup": "The Bank",
        "play": "Integrate the final safe profile and calculate the real time saving",
        "task": "Integrate the final safe profile and calculate the real time saving",
        "question": "How many seconds does the final safe profile remove from one trip?",
    ...
    },
    {
      ...
      "takeaway": "A rate that tapers to nothing does half the work its quoted peak suggests. What it delivers is the area underneath it.",
      "place": "The Bank",
      "at": "profile-desk",
    ...
    },
    {
      ...
      "takeaway": "A record of a rate gives up its totals only to an integration. An area is worth nothing until both of its limits are fixed.",
      "place": "The Bank",
      "at": "depth-dial",
  ...
  "WIND": [
    {
      "day": 1,
      "title": "Where can twelve seconds safely come from?",
      "scene": "The current trip and the proposed trip are side by side. The shaft depth, full-speed limit, loading time, and signals stay fixed. Only the acceleration ramps and the slow final approach are being changed.",
      "takeaway": "A cycle time is the sum of parts fixed by different things. Only some of them are anybody's to choose.",
      "place": "Winder House",
      "at": "winder-desk",
      ...
      "story": "The current trip and the proposed trip are side by side. The shaft depth, full-speed limit, loading time, and signals stay fixed. Only the acceleration ramps and the slow final approach are being changed.",
      "game": {
        "type": "CHOICE",
        "title": "Where can twelve seconds safely come from?",
        "setup": "Winder House",
        "play": "Find which parts of a trip can actually be shortened",
        "task": "Find which parts of a trip can actually be shortened",
        "question": "Which parts of the trip can actually supply the winding engineer Marchetti's twelve-second saving?",
    ...
    {
      "day": 2,
      "title": "How hard is the eighteen-tonne drum to spin?",
      "scene": "The winding drum is an eighteen-tonne steel cylinder, 2.1 metres to its outside and 1.9 metres to its bore. Instead of trusting the old file, you use those dimensions to find how strongly the drum resists being spun up.",
      "takeaway": "A moment of inertia is an integral over the body. Two bodies of one mass can differ in it by a factor of two.",
      "place": "Winder House",
      "at": "drum",
      ...
      "story": "The winding drum is an eighteen-tonne steel cylinder, 2.1 metres to its outside and 1.9 metres to its bore. Instead of trusting the old file, you use those dimensions to find how strongly the drum resists being spun up.",
      "game": {
        "type": "DERIVE",
        "title": "How hard is the eighteen-tonne drum to spin?",
        "setup": "Winder House",
        "play": "Recalculate the drum's inertia from its actual dimensions",
    ...
    {
      "day": 3,
      "title": "Why does a hard ramp feel different?",
      "scene": "Anand, the winder driver, compares two trips that both end the ramp at the same speed. One gets there gently; the other changes velocity more quickly. She says the difference is obvious through the seat and controls even before she looks at a gauge.",
      ...
      "story": "Anand, the winder driver, compares two trips that both end the ramp at the same speed. One gets there gently; the other changes velocity more quickly. She says the difference is obvious through the seat and controls even before she looks at a gauge.",
      "game": {
        "type": "CHOICE",
        "title": "Why does a hard ramp feel different?",
        "setup": "Winder House",
        "play": "Explain why two ramps that reach the same speed can feel different",
        "task": "Explain why two ramps that reach the same speed can feel different",
        "question": "What is different between a hard ramp and a soft one that reach the same final speed?",
    ...
    {
      "day": 4,
      "title": "Does the motor have enough torque?",
      "scene": "You now have the measured drum inertia, the maximum rope tension, the drum radius, and the proposed acceleration. Marchetti puts the motor's continuous torque rating beside them and asks for the worst required torque.",
      "takeaway": "The torque a wind needs is the load torque plus the inertia torque. The second is the smaller of the two.",
      "place": "Winder House",
      "at": "winder-desk",
      ...
      "story": "You now have the measured drum inertia, the maximum rope tension, the drum radius, and the proposed acceleration. Marchetti puts the motor's continuous torque rating beside them and asks for the worst required torque.",
      "game": {
        "type": "DERIVE",
        "title": "Does the motor have enough torque?",
        "setup": "Winder House",
        "play": "Calculate the motor torque at the hardest part of the upward ramp",
        "task": "Calculate the motor torque at the hardest part of the upward ramp",
        "question": "What torque must the motor produce at the start of the upward trip, and is it inside the rating?",
    ...
    {
      "day": 5,
      "title": "How much did the cage-only calculation miss?",
      "scene": "The new total is about 116 megajoules. The old submission treated only the four-tonne cage as being raised through the full shaft. You calculate that term on its own so the missing share has a name.",
      "takeaway": "Energy stored against gravity depends on the mass and the height. It depends on nothing about the route or the speed.",
      "place": "Winder House",
      "at": "drum",
      ...
      "story": "The new total is about 116 megajoules. The old submission treated only the four-tonne cage as being raised through the full shaft. You calculate that term on its own so the missing share has a name.",
      "game": {
        "type": "BALLPARK",
        "title": "How much did the cage-only calculation miss?",
        "setup": "Winder House",
        "play": "Compare the old cage-only energy with the true total",
        "task": "Compare the old cage-only energy with the true total",
        "question": "If you count only the cage, how much of the trip's 116 megajoules do you capture?",
        "answer": "",
    ...
    {
      "day": 6,
      "title": "Which moment is hardest on the motor?",
      "scene": "Four moments from one upward trip are on the board: early acceleration, the end of the ramp, full-speed travel higher in the shaft, and retardation. You put them in order by the power each demands.",
      ...
      "story": "Four moments from one upward trip are on the board: early acceleration, the end of the ramp, full-speed travel higher in the shaft, and retardation. You put them in order by the power each demands.",
      "game": {
        "type": "SEQUENCE",
        "title": "Which moment is hardest on the motor?",
        "setup": "Winder House",
        "play": "Order the four moments from lowest to highest motor power.",
        "task": "Order the four moments from lowest to highest motor power.",
        "question": "Order the four moments from lowest to highest motor power.",
        "answer": "",
    ...
    {
      "day": 7,
      "title": "What can the brake actually stop?",
      "scene": "The brake pads clamp the drum flanges in the winder house. The cage is 1,200 metres away, connected through a rope that stretches. Anand asks what object the brake can stop directly, and what must respond through the rope.",
      ...
      "story": "The brake pads clamp the drum flanges in the winder house. The cage is 1,200 metres away, connected through a rope that stretches. Anand asks what object the brake can stop directly, and what must respond through the rope.",
      "game": {
        "type": "CHOICE",
        "title": "What can the brake actually stop?",
        "setup": "Winder House",
        "play": "Identify what the brake directly stops",
        "task": "Identify what the brake directly stops",
        "question": "When the brake clamps on, what does it directly stop?",
    ...
    {
      "day": 8,
      "title": "How much energy must the brake absorb?",
      "scene": "Halfway up the shaft, the cage is moving at 8.4 metres a second, hundreds of metres of rope are hanging, and the eighteen-tonne drum is spinning. An emergency stop must remove translational and rotational motion while gravity also changes the balance.",
      ...
      "story": "Halfway up the shaft, the cage is moving at 8.4 metres a second, hundreds of metres of rope are hanging, and the eighteen-tonne drum is spinning. An emergency stop must remove translational and rotational motion while gravity also changes the balance.",
      "game": {
        "type": "DERIVE",
        "title": "How much energy must the brake absorb?",
        "setup": "Winder House",
        "play": "Add every energy term the pads must absorb in an emergency stop",
        "task": "Add every energy term the pads must absorb in an emergency stop",
        "question": "How much energy does an upward emergency stop put into the brake pads?",
    ...
    {
      "day": 9,
      "title": "What should Kerrow measure from now on?",
      "scene": "Four possible upgrades are on the desk: a cage-position recorder at the top, a direct rope-stiffness measurement, a hot brake-friction rig, and a destructive arrestor test. You rank them by how much uncertainty they remove from decisions miners will depend on.",
      ...
      "story": "Four possible upgrades are on the desk: a cage-position recorder at the top, a direct rope-stiffness measurement, a hot brake-friction rig, and a destructive arrestor test. You rank them by how much uncertainty they remove from decisions miners will depend on.",
      "game": {
        "type": "SCIENCETANK",
        "title": "What should Kerrow measure from now on?",
        "setup": "Winder House",
        "play": "Allocate one hundred monitoring points across the four safety upgrades.",
        "task": "Allocate one hundred monitoring points across the four safety upgrades.",
        "question": "Allocate one hundred monitoring points across the four safety upgrades.",
        "answer": "",
    ...
    },
    {
      ...
      "takeaway": "The longest part of a winding cycle is set by the depth and the permitted speed. It is not a place where time can be found.",
      "place": "Winder House",
      "at": "winder-desk",
  ...
  "ROPE": [
    {
      "day": 1,
      "title": "Where does the rope's eleven tonnes belong?",
      "scene": "With the cage at the bottom, about eleven tonnes of rope hang from the drum. The old submission puts that weight into the cage's line and nowhere else. Otieno, the chief rope examiner, asks a simpler question first: which object is actually supporting that rope?",
      "takeaway": "A force belongs to whichever body it acts on. Choosing the body is the first move in every problem here.",
      "place": "Rope Shop",
      "at": "cappel",
      ...
      "story": "With the cage at the bottom, about eleven tonnes of rope hang from the drum. The old submission puts that weight into the cage's line and nowhere else. Otieno, the chief rope examiner, asks a simpler question first: which object is actually supporting that rope?",
      "game": {
        "type": "CHOICE",
        "title": "Where does the rope's eleven tonnes belong?",
        "setup": "Rope Shop",
        "play": "Decide which body carries the rope's own weight",
    ...
    {
      "day": 2,
      "title": "What is the greatest pull on the rope?",
      "scene": "The cage is starting upward from 1,240 metres down while almost the whole rope hangs below the drum. Otieno has the rope's mass per metre and Marchetti's peak acceleration on the board. This is the largest pull the rope is asked to carry in normal operation.",
      ...
      "story": "The cage is starting upward from 1,240 metres down while almost the whole rope hangs below the drum. Otieno has the rope's mass per metre and Marchetti's peak acceleration on the board. This is the largest pull the rope is asked to carry in normal operation.",
      "game": {
        "type": "DERIVE",
        "title": "What is the greatest pull on the rope?",
        "setup": "Rope Shop",
        "play": "Find the maximum rope tension at the drum",
        "task": "Find the maximum rope tension at the drum",
        "question": "What is the tension at the drum as the loaded cage accelerates upward from the bottom?",
    ...
    {
      "day": 3,
      "title": "Why can the rope give energy back?",
      "scene": "In the rope shop, a short length of the same steel is clamped between two anchors. Pull it and it stretches; release it and it passes through its starting length before coming back again. Otieno asks what property creates that motion.",
      "takeaway": "A restoring force proportional to displacement is what makes an oscillation. It gives the motion a period of its own.",
      "place": "Rope Shop",
      "at": "coil-rig",
      ...
      "story": "In the rope shop, a short length of the same steel is clamped between two anchors. Pull it and it stretches; release it and it passes through its starting length before coming back again. Otieno asks what property creates that motion.",
      "game": {
        "type": "CHOICE",
        "title": "Why can the rope give energy back?",
        "setup": "Rope Shop",
        "play": "Explain why the long steel rope can store and return energy",
        "task": "Explain why the long steel rope can store and return energy",
        "question": "What makes 1,240 metres of steel rope behave like a spring rather than a rigid link?",
    ...
    {
      "day": 4,
      "title": "What else changed when the rope was shortened?",
      "scene": "The rope has been shortened four times, ten metres at each re-cap, while its material and cross-section stayed the same. Nowak, the rope splicer, asks which mechanical property moved when the length did.",
      ...
      "story": "The rope has been shortened four times, ten metres at each re-cap, while its material and cross-section stayed the same. Nowak, the rope splicer, asks which mechanical property moved when the length did.",
      "game": {
        "type": "CHOICE",
        "title": "What else changed when the rope was shortened?",
        "setup": "Rope Shop",
        "play": "Work out what repeated rope shortening changes besides its length",
        "task": "Work out what repeated rope shortening changes besides its length",
        "question": "What has forty metres of shortening changed that nobody updated in the safety file?",
    ...
    {
      "day": 5,
      "title": "How fast does the cage bounce on the rope?",
      "scene": "With the cage at the bottom, 1,240 metres of locked-coil steel hang between drum and cage. You calculate how stiff that long rope is and how long a four-tonne cage would take to complete one natural oscillation on it.",
      "takeaway": "Stiffness is the material times the area over the length. The period the cage has on it follows from that and the mass.",
      "place": "Rope Shop",
      "at": "coil-rig",
      ...
      "story": "With the cage at the bottom, 1,240 metres of locked-coil steel hang between drum and cage. You calculate how stiff that long rope is and how long a four-tonne cage would take to complete one natural oscillation on it.",
      "game": {
        "type": "DERIVE",
        "title": "How fast does the cage bounce on the rope?",
        "setup": "Rope Shop",
        "play": "Calculate the rope stiffness and the cage's natural bounce period",
        "task": "Calculate the rope stiffness and the cage's natural bounce period",
        "question": "What is the rope's stiffness at the bottom, and what natural period does it give the cage?",
      ...
      "equations": [
        {
          "e": "ω = √(k/m),  T = 2π√(m/k)",
          "c": "the period of a mass on a spring",
          "v": [
            [
              "k",
              "the stiffness of the rope, in newtons a metre"
            ],
            [
              "m",
              "the mass hanging on it, in kilograms"
            ],
            [
              "T",
    ...
    {
      "day": 6,
      "title": "Which explanation fits every March record?",
      "scene": "The March evidence is finally on one bench. The brake was applied on time. The drum stopped. The cage continued. The pads were replaced afterward. Your job is not to choose the loudest clue; it is to choose the cause that explains all of them.",
      "takeaway": "Pads wear from the energy they absorb. A stop that goes on longer absorbs more of it at the same force.",
      "place": "Rope Shop",
      "at": "rope-bench",
      ...
      "story": "The March evidence is finally on one bench. The brake was applied on time. The drum stopped. The cage continued. The pads were replaced afterward. Your job is not to choose the loudest clue; it is to choose the cause that explains all of them.",
      "game": {
        "type": "DIAGNOSIS",
        "title": "Which explanation fits every March record?",
        "setup": "Rope Shop",
        "play": "Choose the explanation that makes every March record true at the same time.",
        "task": "Choose the explanation that makes every March record true at the same time.",
        "question": "Choose the explanation that makes every March record true at the same time.",
    ...
    },
    {
      ...
      "takeaway": "Two forces acting at the same place can belong to different diagrams. Which body each acts on is what decides the pairing.",
      "place": "Rope Shop",
      "at": "cappel",
  ...
  "CAGE": [
    {
      "day": 1,
      "title": "How hard must the rope pull on the loaded cage?",
      "scene": "The cage and its riders have a total mass of 4,000 kilograms. At the start of the faster ramp they accelerate upward at 1.2 metres a second squared. Rahimi, the shaft engineer, asks for the upward rope tension needed just for the cage and riders, before the weight of the long rope itself is added later.",
      "takeaway": "The rope must support the loaded cage's weight and also provide the extra force for its upward acceleration. The rope's own weight is added only when the larger hanging system is considered.",
      "place": "Shaft and Brake House",
      "at": "body-bench",
      "guide": "Draw one body around the loaded cage and its riders. Two external forces act on that body: the rope pulls upward and gravity pulls downward. Their difference is the net upward force. The rope's own eleven tonnes are not part of this body; they enter later when you calculate the tension at the drum.",
      "story": "The cage and its riders have a total mass of 4,000 kilograms. At the start of the faster ramp they accelerate upward at 1.2 metres a second squared. Rahimi, the shaft engineer, asks for the upward rope tension needed just for the cage and riders, before the weight of the long rope itself is added later.",
      "game": {
        "type": "BALLPARK",
        "title": "How hard must the rope pull on the loaded cage?",
        "setup": "Shaft and Brake House",
        "play": "Find the support force needed to accelerate the loaded cage",
        "task": "Find the support force needed to accelerate the loaded cage",
        "question": "How much upward force must the rope exert on the loaded cage at peak acceleration?",
        "answer": "",
        "why": "The rope must pull upward with about 44 kilonewtons on the loaded cage and riders. For this body, T − mg = ma, so T = m(g + a). This is only the support force for the cage and its occupants. It is not yet the maximum tension in the winding rope, because the long hanging rope has its own weight. That larger tension is the question you reach on day three.",
        "givens": [],
        "relationship": "Net force equals mass times acceleration, so the rope tension is the mass times gravity plus the upward acceleration.",
        "calcKey": "CAGE-1"
      },
      "assumes": [
    ...
    {
      "day": 2,
      "title": "What does a hard stop feel like to a rider?",
      "scene": "An eighty-two-kilogram miner is standing on the cage floor while the cage is still moving upward but slowing at 1.1 metres a second squared. Rahimi asks what upward force the floor exerts on that person during the stop.",
      ...
      "story": "An eighty-two-kilogram miner is standing on the cage floor while the cage is still moving upward but slowing at 1.1 metres a second squared. Rahimi asks what upward force the floor exerts on that person during the stop.",
      "game": {
        "type": "BALLPARK",
        "title": "What does a hard stop feel like to a rider?",
        "setup": "Shaft and Brake House",
        "play": "Calculate what a rider feels during the stopping ramp",
        "task": "Calculate what a rider feels during the stopping ramp",
        "question": "What upward force does the cage floor exert on an eighty-two-kilogram rider while the rising cage slows?",
        "answer": "",
    ...
    {
      "day": 3,
      "title": "Can a cold brake test predict a real emergency stop?",
      "scene": "Craig, the brake fitter, lays the inquiry certificate beside a used brake pad. The certificate lists the friction coefficient, test pressure, instrument, and temperature. The inquiry quoted the coefficient but mostly forgot the other three.",
      ...
      "place": "Shaft and Brake House",
      "at": "pad-bench",
      "guide": "Four readings of what a friction coefficient tells you about a brake. Ask of each what the measurement actually did. A coefficient sets the most a surface can hold, not what it is holding at any moment. The distinction that decides this card is between a limit and a value.",
      "story": "Craig, the brake fitter, lays the inquiry certificate beside a used brake pad. The certificate lists the friction coefficient, test pressure, instrument, and temperature. The inquiry quoted the coefficient but mostly forgot the other three.",
      "game": {
        "type": "CHOICE",
        "title": "Can a cold brake test predict a real emergency stop?",
        "setup": "Shaft and Brake House",
        "play": "Decide what the brake's cold-bench friction number really proves",
        "task": "Decide what the brake's cold-bench friction number really proves",
        "question": "What does Craig's cold-bench friction coefficient actually tell us?",
    ...
    {
      "day": 4,
      "title": "How much energy is in one full lift?",
      "scene": "A loaded four-tonne cage rises 1,240 metres. At the start, almost the whole 8.9-kilogram-per-metre rope hangs below the drum; by the end, almost none does. The lifting force therefore falls continuously as the cage rises.",
      ...
      "story": "A loaded four-tonne cage rises 1,240 metres. At the start, almost the whole 8.9-kilogram-per-metre rope hangs below the drum; by the end, almost none does. The lifting force therefore falls continuously as the cage rises.",
      "game": {
        "type": "DERIVE",
        "title": "How much energy is in one full lift?",
        "setup": "Shaft and Brake House",
        "play": "Calculate the work of lifting the cage and the changing length of hanging rope",
        "task": "Calculate the work of lifting the cage and the changing length of hanging rope",
        "question": "How much work does one trip from the bottom to the top do against gravity?",
    ...
    {
      "day": 5,
      "title": "What force would the emergency arrestor feel?",
      "scene": "A maker's test mass has crushed an arrestor to about half its height. One force acted on the falling mass; its partner acted on the arrestor. You identify the pair before anyone combines them in the same free-body diagram.",
      "takeaway": "An interaction is one thing seen twice, and its two halves belong to two different diagrams.",
      "place": "Shaft and Brake House",
      "at": "arrestor",
      "guide": "Four accounts of what happened between the falling mass and the arrestor on the rig. Ask of each which body each force acts on. A force and its partner never appear in the same free-body diagram. The distinction that decides this card is between two forces on one body and one force seen from both ends.",
      "story": "A maker's test mass has crushed an arrestor to about half its height. One force acted on the falling mass; its partner acted on the arrestor. You identify the pair before anyone combines them in the same free-body diagram.",
      "game": {
        "type": "CHOICE",
        "title": "What force would the emergency arrestor feel?",
        "setup": "Shaft and Brake House",
        "play": "Relate the force on a stopped mass to the force on the arrestor",
        "task": "Relate the force on a stopped mass to the force on the arrestor",
        "question": "When an arrestor stops a falling mass, how does the force on the arrestor compare with the force on the mass?",
        "answer": "Equal and opposite, and on different bodies, so neither cancels the other",
        "why": "They are one interaction seen from both ends. Equal in size, opposite in direction, and acting on different bodies. That is why they do not cancel. A cancellation would need both forces on the same body. The mass's diagram has the arrestor pushing up on it and gravity pulling down. The arrestor's diagram has the mass pushing down on it and the rig holding it up. Each diagram is solved on its own, and the pair ties the two solutions together.",
        "rebuttals": [
    ...
    {
      "day": 6,
      "title": "Why did March destroy the pads?",
      "scene": "Craig compares years of ordinary stops with the March emergency stop. The clamp force was not exceptional, but the pads had to absorb a very different amount of motion before everything came to rest.",
      ...
      "story": "Craig compares years of ordinary stops with the March emergency stop. The clamp force was not exceptional, but the pads had to absorb a very different amount of motion before everything came to rest.",
      "game": {
        "type": "CHOICE",
        "title": "Why did March destroy the pads?",
        "setup": "Shaft and Brake House",
        "play": "Decide whether brake-pad damage is set by force or by energy",
        "task": "Decide whether brake-pad damage is set by force or by energy",
        "question": "What decides how much punishment an emergency stop gives the brake pads?",
    ...
    {
      "day": 7,
      "title": "Where is the energy in the stretched rope?",
      "scene": "The rope is about 1.3 metres longer under load than when unloaded. Rahimi puts that stretch beside the March overshoot and asks what physical quantity is stored while the steel is stretched.",
      ...
      "story": "The rope is about 1.3 metres longer under load than when unloaded. Rahimi puts that stretch beside the March overshoot and asks what physical quantity is stored while the steel is stretched.",
      "game": {
        "type": "CHOICE",
        "title": "Where is the energy in the stretched rope?",
        "setup": "Shaft and Brake House",
        "play": "Identify the energy stored in the stretched rope",
        "task": "Identify the energy stored in the stretched rope",
        "question": "What is the rope storing while it is stretched by about a metre and a third?",
    ...
    {
      "day": 8,
      "title": "Can the rope explain the extra 1.6 metres?",
      "scene": "In March the drum was braked from 8.4 metres a second while the descending cage was about forty metres above the bottom landing. The drum stopped first. Using the rope stiffness and the cage's motion, you predict how much farther the cage should travel.",
      ...
      "story": "In March the drum was braked from 8.4 metres a second while the descending cage was about forty metres above the bottom landing. The drum stopped first. Using the rope stiffness and the cage's motion, you predict how much farther the cage should travel.",
      "game": {
        "type": "DERIVE",
        "title": "Can the rope explain the extra 1.6 metres?",
        "setup": "Shaft and Brake House",
        "play": "Predict how far the cage moves after the drum has stopped",
        "task": "Predict how far the cage moves after the drum has stopped",
        "question": "How far should the cage travel past the drum's stopping point?",
    ...
    {
      "day": 9,
      "title": "Does the real stop match the prediction?",
      "scene": "The empty cage is released for one test trip. Before Craig touches the emergency brake, you predict how long the drum should take to stop from 8.4 metres a second. The recorder will show whether the real machine agrees.",
      ...
      "story": "The empty cage is released for one test trip. Before Craig touches the emergency brake, you predict how long the drum should take to stop from 8.4 metres a second. The recorder will show whether the real machine agrees.",
      "game": {
        "type": "VERIFY",
        "title": "Does the real stop match the prediction?",
        "setup": "Shaft and Brake House",
        "play": "Predict the drum stopping time, run one test, and compare prediction with measurement",
    ...
    {
      "day": 10,
      "title": "What safety limits should the inspector sign?",
      "scene": "Four findings are on the bench: the motor margin, the rope-driven overshoot, the brake's energy limit, and the rope's changing stiffness after re-capping. You turn each one into the rule that belongs in the signed operating profile.",
      ...
      "story": "Four findings are on the bench: the motor margin, the rope-driven overshoot, the brake's energy limit, and the rope's changing stiffness after re-capping. You turn each one into the rule that belongs in the signed operating profile.",
      "game": {
        "type": "CASEBOOK",
        "title": "What safety limits should the inspector sign?",
        "setup": "Shaft and Brake House",
        "play": "Match each finding to the operating rule it requires.",
        "task": "Match each finding to the operating rule it requires.",
        "question": "Match each finding to the operating rule it requires.",
        "answer": "",
  ...
  "TIP": [
    {
      "day": 1,
      "title": "Why did the belt-drive bolts shear?",
      "scene": "Ore falls onto the conveyor at 320 tonnes an hour with no forward speed. The belt has to accelerate every kilogram to 2.5 metres a second as it lands. That continuous change of momentum is a force the old static calculation never included.",
      ...
      "story": "Ore falls onto the conveyor at 320 tonnes an hour with no forward speed. The belt has to accelerate every kilogram to 2.5 metres a second as it lands. That continuous change of momentum is a force the old static calculation never included.",
      "game": {
        "type": "DERIVE",
        "title": "Why did the belt-drive bolts shear?",
        "setup": "Tip and Conveyor",
        "play": "Find the force created when a continuous stream of ore is accelerated by the belt",
        "task": "Find the force created when a continuous stream of ore is accelerated by the belt",
        "question": "What horizontal force does the moving ore add to the belt drive?",
    ...
    {
      "day": 2,
      "title": "Why do static load ratings keep failing at Kerrow?",
      "scene": "A skip dumps four tonnes of moving ore into a stationary bin twenty times a shift. The old bolt calculation used only the weight of a full bin. The missing quantity is the momentum that has to go somewhere when the ore stops.",
      ...
      "story": "A skip dumps four tonnes of moving ore into a stationary bin twenty times a shift. The old bolt calculation used only the weight of a full bin. The missing quantity is the momentum that has to go somewhere when the ore stops.",
      "game": {
        "type": "CHOICE",
        "title": "Why do static load ratings keep failing at Kerrow?",
        "setup": "Tip and Conveyor",
        "play": "Track the momentum of ore when it is dumped into a stationary bin",
  ...
  "GRAV": [
    {
      "day": 1,
      "title": "Can we trust one gravity reading?",
      "scene": "Adebayo, the survey assistant, opens the gravity field book. Each station has a reading, a time, and an elevation, and the reference station is measured again at the end of the day. Those extra entries are what turn a sensitive spring reading into a usable measurement.",
      ...
      "at": "level-book",
      "guide": "Adebayo reads the same station twice a day for a reason that has nothing to do with carefulness for its own sake. A gravimeter is a spring, and a spring left alone still creeps. It is the way a bathroom scale drifts if somebody stands on it for an hour. Each entry in his field book answers one question. Ask of each whether it says something about the ground under your feet, or something about the instrument slowly settling in its own case. The one that is about the instrument is exactly why the same station gets read twice.",
      "story": "Adebayo, the survey assistant, opens the gravity field book. Each station has a reading, a time, and an elevation, and the reference station is measured again at the end of the day. Those extra entries are what turn a sensitive spring reading into a usable measurement.",
      "game": {
        "type": "CASEBOOK",
        "title": "Can we trust one gravity reading?",
        "setup": "Gravity Station",
        "play": "Match each field-book entry to the correction or measurement it provides.",
        "task": "Match each field-book entry to the correction or measurement it provides.",
        "question": "Match each field-book entry to the correction or measurement it provides.",
        "answer": "",
    ...
    {
      "day": 2,
      "title": "What should gravity do at the bottom of the mine?",
      "scene": "At the gravity hut, Sokol puts two corrected readings on the bench, one at the surface and one 1,240 metres down. The shell theorem tells you which parts of Earth still pull on a point inside it. First you predict the change with depth.",
      ...
      "story": "At the gravity hut, Sokol puts two corrected readings on the bench, one at the surface and one 1,240 metres down. The shell theorem tells you which parts of Earth still pull on a point inside it. First you predict the change with depth.",
      "game": {
        "type": "DERIVE",
        "title": "What should gravity do at the bottom of the mine?",
        "setup": "Gravity Station",
        "play": "Predict how gravity should change 1,240 metres below the surface",
        "task": "Predict how gravity should change 1,240 metres below the surface",
        "question": "For a uniform spherical Earth, how should gravity change over the 1,240-metre shaft?",
    ...
    {
      "day": 3,
      "title": "Does the gravity difference make physical sense?",
      "scene": "The free-air prediction and the measured shaft gradient are now side by side. Their difference comes from rock that changes from being below you to surrounding and above you as you descend. The implied density is the consistency check.",
      ...
      "place": "Gravity Station",
      "at": "gravimeter",
      "guide": "Five quantities are offered and three of them make the answer. The free-air figure is what gravity does with height alone. The measured figure is what this shaft gives. The coefficient turns a density into a gradient. Two are not needed. The depth cancels out of a gradient, and the mean density of the whole earth belongs to the uniform sphere this shaft has just disagreed with.",
      "story": "The free-air prediction and the measured shaft gradient are now side by side. Their difference comes from rock that changes from being below you to surrounding and above you as you descend. The implied density is the consistency check.",
      "game": {
        "type": "BALLPARK",
        "title": "Does the gravity difference make physical sense?",
        "setup": "Gravity Station",
        "play": "Use the measured gravity gradient to infer the density of the rock around the shaft",
        "task": "Use the measured gravity gradient to infer the density of the rock around the shaft",
        "question": "What rock density does the measured gravity gradient imply?",
        "answer": "",
...
export const BALLPARK_CALCS = {
  "CAGE-1": {
    "prompt": "Treat the loaded cage and its riders as one body. The rope pulls up, gravity pulls down, and the cage accelerates upward at the peak of the proposed ramp.",
    "question": "How much upward force must the rope exert on the loaded cage at peak acceleration?",
    "labels": [
    ...
    "tolerance": 500,
    "units": "N",
    "solution": "4000 × (9.81 + 1.2) = 44,040 N of rope tension on the loaded cage.",
    "explanation": "The rope's eleven tonnes are not inside the chosen body, so they do not belong in this first support-force calculation. They matter later when you ask for the tension at the drum. The final speed also does not enter a force calculation."
  },
  "CAGE-2": {
...
export const JARGON = [
  ...
  },
  {
    ...
    "def": "The machine that raises and lowers the rope: a motor, a gearbox and a brake."
  },
  {
    "name": "Wind",
    "aliases": [
