...
export const MISSIONS = [
  ...
  },
  {
    ...
    "stake": "Day 3. Two drains may be meeting in a closed tunnel under the yard and the closed-space safety officer, Femi Oyelaran, has a crew suited up at the hatch waiting on your word. He will not send them in on a story. Oyelaran has monitors at the hatch and two hours of bottled air per man. Today you work out the largest reaction that could be happening down there, and whether the reaction you assumed is the one really going on. What hurts people in a closed space is ordinary: heat, pressure, and oxygen pushed out.",
  ...
  },
  {
    ...
    "stake": "Day 17. The main plume cleared a week ago and residents came home the day after. Since then Varga's monitors climb every afternoon and drop overnight, and he has been ignored twice because the release is over. He has three fixed monitors, all of them on the yard fence, and one van. Today you work out what is forming out there and move the monitoring to where and when it could see it. Monitoring built for the release will keep reporting that the release is over, and it will be right. People are back in their houses with the windows open.",
  ...
  },
  {
    ...
    "stake": "Day 21, eleven in the morning. The fire has been out for three weeks and one storage bay is still getting warmer. Tomas Brandt, who owns reactions and energy, has been reading it hourly since midnight and has 11 readings. Fire Command wants the site released tonight and the crews have been on shift for 14 hours. Today you work out how much energy it takes to warm that much material, decide whether you are watching leftover heat or a reaction still running, and set up the monitoring either way. Fire Command wants your answer after the next reading, not after the trend.",
  ...
  },
  {
    ...
    "stake": "Day 31. The treatment chemical sat quietly in a drum all week; in Brandt's warm pilot vessel it is lively. His own trace shows an hour of very little and then a step. Osei plans to run it at full scale on Monday — the pilot vessel holds 40 litres and the plant tank holds 9000. Today you decide what temperature range this process may run in, and what shuts it down without asking anybody. Treatment also gathers a spill spread thin across a yard into a single tank, and if that tank runs away, the whole of it leaves at once, hot.",
