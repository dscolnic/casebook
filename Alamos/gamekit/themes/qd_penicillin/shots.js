// shots.js — where to stand to photograph this department.
//
...
// toward the broth room; θ = 0 looks back toward the porch.
...
export const VIEWS = [
  { name: 'corridor--from-the-porch', at: { x: 0, z: 2 }, yaw: UP,
  ...
  { name: 'corridor--from-the-far-end', at: { x: 0, z: 41 }, yaw: BACK,
    note: 'back down the length of it, past the broth room door' },
];
