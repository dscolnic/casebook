...
export default {
  ...
  //
  // Same fifteen days as themes/the_trial, so the same fifteen pieces: this
  ...
  opening: [
    'The independent monitoring board sits in three weeks. It can stop CLARION-3. The trial is four '
    + 'years old. It holds 2,400 people across 31 hospitals. Half are on a new drug. Half are on the '
    + 'usual care. Nobody in this building knows which is which. You are the methodology and operations '
    + 'lead at the coordinating centre. What that board sees is what you send it. In 15 days you hand '
    + 'over the monitoring board pack. It says what the trial promised to measure before it had any '
    + 'data. It says what it has measured since. And it says how much of the gap between the two arms '
    + 'can honestly be claimed. One section is written a day. Stop the trial early on noise, and a drug '
    + 'that works is buried for 10 years. Carry on past the point the evidence was in, and everybody '
    + 'who joins after today is in a trial that already had its answer.',
  ],
