...
export const VIEWS = [
  ...
  { name: 'genome-room--doorway', at: { x: -3.3, y: 1.6, z: 8.0 }, yaw: WEST,
    note: 'across the genome room, looking at the far wall' },
  { name: 'design-desk--doorway', at: { x: -3.3, y: 1.6, z: 30.5 }, yaw: WEST,
    note: 'across the design desk, looking at the far wall' },
  { name: 'editing-bay--doorway', at: { x: 3.3, y: 1.6, z: 9.5 }, yaw: EAST,
    note: 'across the editing bay, looking at the far wall' },
  { name: 'sequencing-room--doorway', at: { x: 3.3, y: 1.6, z: 26.5 }, yaw: EAST,
    note: 'across the sequencing room, looking at the far wall' },
];
