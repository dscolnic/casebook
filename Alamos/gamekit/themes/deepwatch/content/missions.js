...
export const MISSIONS = [
  {
    ...
    "stake": "Two hours to sailing, alongside, and the fire main isolation valve in the forward compartment is chained shut with nobody willing to say who chained it. Chief Ferro wants to walk you through the boat before you take your first watch tonight. This watch you learn the forward spaces, what the fittings on a bulkhead are for, and how to get from one end of the boat to the other without looking at anything. A submarine is not a list of compartment names. It is a set of systems running through those compartments — water, air, power, cooling — and a set of boundaries that hold when one of them fails. Learning it as a sequence matters, because a sequence survives being interrupted and a mental picture does not. Tonight you may have to find that valve in the dark, in smoke, by feel.",
  ...
  },
  {
    ...
    "stake": "Second day out, forenoon watch. Four traces on the broadband display, and Rask has been arguing with Dunne about the fourth for eleven minutes: it holds almost the same bearing and it is getting louder. Commander Vance wants a classification before the boat commits to the track she has been ordered onto. This watch you sort out what is out there and say what a steady bearing means. Sound is all you have. What it tells you comes from how the bearing changes over time, what frequencies are in it, and how the water itself carries it — a layer of different temperature can hide a close contact and pass a distant one. And a bearing that does not change is not a quiet situation. It is the signature of two ships on converging courses.",
  ...
  },
  {
    ...
    "stake": "Third day, middle watch, and the last trusted fix was three and a half hours ago. Sowande has the plot built from course, speed and time, Petrov has been reading the fathometer, and the two of them do not agree. There is a current here of about half a knot that nobody has measured today. This watch you work out how far the water has carried the boat, decide which instrument to believe, and get a position that does not depend on the plot at all. Dead reckoning is honest arithmetic with a growing error: every minute since the last fix adds uncertainty, and a current adds it in a direction you cannot see. Worse, two displays can agree beautifully because they take their heading from the same gyro, and agreement like that measures nothing. Sixty fathoms, and a bank half a mile off the track.",
  ...
  },
  {
    ...
    "stake": "Fifth day, first watch. The narrows are four miles across, the transit takes eleven hours, and the plot's uncertainty is a circle two miles wide. Whitfield wants to wait for a better fix. Vance points out that waiting puts the boat in the middle of the strait at first light, which is worse than any argument about the plot — and this time she is right. This watch you decide what has to be true before the boat commits, how much margin the passage really has, and what Haruki can afford to shut down for Rask. Everything mechanical aboard makes noise: rotating machinery, water over the hull, people. Quiet is bought by switching things off, and each one costs cooling, air treatment, or the speed you would want if this goes wrong. Margin is the number that matters.",
  ...
  },
  {
    ...
    "stake": "Sixth day, morning watch, and water is over the bilge in the forward space with the drain pump running. Hallam has the level and reports it steady. Ferro does not believe steady means anything and is looking for the hole. This watch you find where the water is coming in, work out whether pumping can win, and decide what shutting that supply costs elsewhere — the two valves that stop it sit on a header that feeds other things. Flooding is a race between two rates. Water comes in faster the deeper the boat is, because pressure drives it, and a pump's rate does not improve to match. So a steady level means only that today's two rates happen to be equal, and it will not stay steady if the boat goes deeper. Pumping buys minutes. They are worth nothing unless somebody spends them finding the source.",
  ...
  },
  {
    ...
    "stake": "Same day, afternoon watch, eight hours after the flooding and nobody has slept. Smoke from a switchboard in the electrical space. The indicator shows the bus open and Mbeki's meter on the cable inside reads four hundred and forty volts. Okonkwo will not send anybody in on the strength of a lamp. This watch you take the fire apart into the things keeping it alive, decide what that meter is telling you, and work out how to fight a space nobody can see into. A fire needs fuel, oxygen and heat. An electrical one makes its own heat continuously and stays lit until the supply is dead, which is why the order of your actions matters more than the speed of any one of them. And an indicator lamp is a claim about a switch, not a measurement of a cable.",
  ...
  },
  {
    ...
    "stake": "Eighth day, middle watch. The scrubber plant is running and its outlet reads clean. Navarro has been round berthing with a handheld meter and it reads far higher than the sensor on that bulkhead, where nine people are asleep. Lindqvist has to decide whether to wake them. This watch you decide whether it is the air or the instrument that is wrong, work out how long that space is safe, and fix the circulation. Air treatment is a transport problem before it is a chemistry problem. A scrubber cleans only the air that reaches it, so a shut damper leaves one space filling while every panel in control reads normal, and a fixed sensor reports its own corner. This is the one system where the crew notice before the instruments do — headaches, short tempers, people asleep on watch — and they already have.",
  ...
  },
  {
    ...
    "stake": "Eleventh day. The broadband noise floor is up across every bearing rather than in one sector, and Dunne has found a new narrowband line at a hundred and thirteen hertz that grows with turns. Rask says the boat is shouting into its own array; Haruki says his plant is running exactly as it was yesterday. This watch you decide whether the noise is outside the boat or inside it, narrow it to one machine, and say what kind of fault makes a line like that. Noise up on every bearing at once is not how the sea behaves. Proving which machine is a matter of correlation: it starts when something starts, changes when that changes, and stops when it stops. A frequency at twice shaft rate points at something rotating with the shaft. A boat that cannot hear is a boat that is only being heard.",
  ...
  },
  {
    ...
    "stake": "Twelfth day, middle watch. The boat is going deeper with the planes already at rise, the trim shows heavy forward, speed is unchanged, and the depth gauge is the calmest instrument in the control room. Ferro is on his way forward without being asked, which tells you what he thinks it is. This watch you decide what is actually causing it, work out how much weight is aboard, and choose which control to use — knowing two of the four are hard to undo at this depth. Depth is the symptom. The cause is either weight the boat has taken on or a force acting on it, and those are corrected in completely different ways. Tonnes-per-metre is what turns a depth change into an amount of water. Treat the symptom and the boat keeps going down while everybody watches the right gauge for the wrong reason.",
  ...
  },
  {
    ...
    "stake": "Fifteenth day, and the argument that has been running all patrol comes due. Four hours of quiet running, and Haruki intends to secure everything on Rask's list to get it — including the second seawater pump and half the carbon dioxide scrubbing. Lindqvist has done the arithmetic on the second one and is not happy. This watch you decide what may be shut down, what may only be slowed, and what the whole configuration costs the boat. Quiet is bought with capability, and the bill arrives late, in another department. One scrubber train means the remaining one removes less than the crew produces, so the air is on a clock from the moment you agree. A quiet boat is also a slow boat, which takes longer to work out what a contact is doing. None of that appears on the same gauge as the decision.",
  ...
  },
  {
    ...
    "stake": "Nineteenth day. The boat has been open to the surface since Tuesday for work on the mast and dives at dawn. The switchboard shows two breakers open from that work, the log says one was restored, and every valve on the rig sheet has signatures against it — including one from a man who was ashore that morning. This watch you work out what each checklist line is really asking, close the boat up in the right order, and decide what to do about a record that does not match. A checklist item is a physical claim about a physical thing, not a signature. The boat is ready when all of those claims are true at once, and the way to know is to go and meter the circuit rather than read the line again. This is the cheapest hour of the patrol.",
  ...
  },
  {
    ...
    "stake": "Twenty-second day, the last full watch of the patrol, and everything is degraded a little. A contact Rask has not resolved. A plot Sowande has not been able to fix since the forenoon. A machine Haruki has not looked at since Tuesday. Whitfield is in the wardroom with the corpsman and a fractured wrist of his own, so the officer you would have handed half of this to is not available. Everything you have been taught turns up tonight in a different order than it was taught in: what the sound means, where the boat really is, which casualty gets worse by itself, what a gauge is and is not saying. Nobody will tell you which problem is the important one. Getting that ranking right is the job, and it is the only part of it that cannot be delegated.",
