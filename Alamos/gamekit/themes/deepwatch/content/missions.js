...
export const MISSIONS = [
  ...
  },
  {
    ...
    "stake": "Sixth day, morning watch, and water is over the bilge in the forward space with the drain pump running. Ruth Hallam, on the pumps, has the level and reports it steady. Ferro does not believe steady means anything and is looking for the hole. This watch you find where the water is coming in, work out whether pumping can win, and decide what shutting that supply costs elsewhere — the two valves that stop it sit on a header that feeds other things. Flooding is a race between two rates. Water comes in faster the deeper the boat is, because pressure drives it, and a pump's rate does not improve to match. So a steady level means only that today's two rates happen to be equal, and it will not stay steady if the boat goes deeper. Pumping buys minutes. They are worth nothing unless somebody spends them finding the source.",
  ...
  },
  {
    ...
    "stake": "Same day, afternoon watch, eight hours after the flooding and nobody has slept. Smoke from a switchboard in the electrical space. The indicator shows the bus open and a meter his own electrician's mate put on the cable inside reads four hundred and forty volts. The chief electrician, Bede Okonkwo, will not send anybody in on the strength of a lamp. This watch you take the fire apart into the things keeping it alive, decide what that meter is telling you, and work out how to fight a space nobody can see into. A fire needs fuel, oxygen and heat. An electrical one makes its own heat continuously and stays lit until the supply is dead, which is why the order of your actions matters more than the speed of any one of them. And an indicator lamp is a claim about a switch, not a measurement of a cable.",
