...
export const VIEWS = [
  ...
  { name: 'flow-room--doorway', at: { x: -3.4, y: 1.6, z: 12.0 }, yaw: WEST,
    note: 'inside the door of the flow room, looking at the far wall' },
  { name: 'model-room--doorway', at: { x: -3.4, y: 1.6, z: 35.5 }, yaw: WEST,
    note: 'inside the door of the model room, looking at the far wall' },
  { name: 'statistics-room--doorway', at: { x: 3.4, y: 1.6, z: 11.5 }, yaw: EAST,
    note: 'inside the door of the statistics room, looking at the far wall' },
  { name: 'policy-desk--doorway', at: { x: 3.4, y: 1.6, z: 26.5 }, yaw: EAST,
    note: 'inside the door of the policy desk, looking at the far wall' },
];
