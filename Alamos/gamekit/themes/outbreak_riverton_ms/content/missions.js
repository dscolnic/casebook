...
export const MISSIONS = [
  {
    ...
    "stake": "Day one. Seven patients, three hospitals, four days, and the same four symptoms in every one of them. Sofia Morales, the epidemiology lead, has the printout, and a reporter downstairs already has the number. Today you decide whether this is an outbreak at all, and agree what counts as a case. Seven sounds like a lot. Morales will not say whether it is until she knows what a normal week here looks like.",
  ...
  },
  {
    ...
    "stake": "Day nine. The hospitals need a working test by sunrise. Ravi Patel, the molecular diagnostics lead, ran the tests overnight. Several patients came back positive. So did one of the controls. That control is a tube with nothing in it. Three thousand people have already been told to stay home on that run. The bulletin goes out at six. Today you decide whether the run can be believed, and what a positive would mean for one patient.",
  ...
  },
  {
    ...
    "stake": "Day thirty-three. Three patients have readings that look close to something found in animals by the river. The council has signed an order. On Saturday the heron colony gets cleared out. Mateo Castellanos, the wildlife vet, has been out there twice. He says the herons are the wrong animal. Today you decide what part any animal really plays here. Then design the sampling that could show it. Living nearby is not the same as being the cause.",
