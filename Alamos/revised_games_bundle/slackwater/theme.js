...
export default {
  ...
  opening: [
    ...
    + 'In twelve days the biggest tide of the year arrives, and a coastal storm may push even more water in; close the gates too late and seawater floods the marsh, but close them too early and river water backs up on the other side. '
    + 'Idris Calloway says the tide can be calculated in advance; Renate Oyelaran says storms add water the tide equations cannot see. '
