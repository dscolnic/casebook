...
export default {
  ...
  delivery: {
    ...
    where: 'ATOM',
    pieces: [
      'What the incoming silicon certificate really proves',
      'Why Yellow Bay is safe under amber light',
      'Which measurements can see the failing surface',
      'What the chamber readings can actually identify',
  ...
  opening: [
    ...
    + 'Two senior engineers disagree about the cause: Ferreira says the silicon arriving at the factory is wrong, while Ostrowski says the chemistry inside the production line has drifted. '
