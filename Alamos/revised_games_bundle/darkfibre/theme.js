...
export default {
  ...
  delivery: {
    ...
    pieces: [
      ...
      'The trace delay turned into an optical distance',
      'A clean break ruled out',
      'The damaged route\'s remaining margin',
      'The receiver\'s photon count',
      'The receiver calibrated from the measured diode',
  ...
  opening: [
    ...
    + 'You are the optical measurements lead. Use the physics of light to answer two questions: what failed, and where is it? Send the ship to the wrong thing or place, and Pellow Head may stay on its last link until the sea reopens.',
  ],
