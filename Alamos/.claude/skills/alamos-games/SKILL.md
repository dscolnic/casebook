---
name: alamos-games
description: The inventory of all 35 Alamos campaigns — what each teaches, its place, its THEME= run command, and why each looks unlike the others. Includes the Quick Discoveries' own rules (grade 9, teach-before-asking, per-campaign format diversity) and the interiorKit/paintMural/screens.js lessons from building them. Read when picking a game up cold, adding a campaign, or touching interior fit-out, murals, worlds, or the Changeover/Yellow Bay multi-plate builders.
---
