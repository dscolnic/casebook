...
//
// Most of it is not new code. `src/props.js` and `src/env.js` already built these
...
import { MATERIALS, box, cyl, post, sign, fenceRun, crateStack } from '../gamekit/engine/world/kit.js';
import { driveable } from '../gamekit/engine/world/driving.js';
import { buildProps } from './src/props.js';
import { plantTrees, srand, srandRange } from './src/env.js';
