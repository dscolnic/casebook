const MISSION_DEFS=[
  ...
  },
  {
    ...
    "stake": "July 1943, and three groups have reported yields that cannot all be right. Seaborg's chemistry says one thing, and Woods's counters another. The sample decays while the chemistry is still running, so the amount at the end is not the amount you started with. Today you handle decay as arithmetic, follow an element through a separation, and measure what a counter reads with nothing in front of it. Woods will not report a number until she has measured that, which is why hers is the count the others are being checked against. A count with no background under it is not a measurement."
  },
  {
  ...
  },
  {
    ...
    "stake": "October 1944. “Nearly simultaneous” has been in every memo for two months. Nobody has written down what it means in microseconds. That is why Kistiakowsky's division and Bethe's have been arguing past each other since August. Today you turn it into a number, calibrate the channels that measure it, and give ordnance a requirement they can build to. Kistiakowsky has four recording channels and no record of when any of them was last checked against another. The memos will go on saying nearly simultaneous until somebody writes a tolerance beside it. Measure simultaneity with instruments that disagree and you have measured the instruments."
  },
  {
