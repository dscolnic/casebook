// Rebuilds ../sequence.html by inlining the data packs in ballpark_build/.
// The packs are the source of truth; the HTML is a generated artifact.
// Usage: node ballpark_build/build_sequence.js
const fs = require("fs");
const path = require("path");

const DIR = __dirname;
const HTML = path.join(DIR, "..", "sequence.html");
...
function build() {
  ...
  console.log("built sequence.html from " + games.length + " packs");
  return games.length;
}
